...
const (
	...
	ApplicationScopes                                = "webhook:write application:read application:write application.auths:read application.webhooks:read application.application_template:read application.tenant_business_type:read bundle.instance_auths:read document.fetch_request:read event_spec.fetch_request:read api_spec.fetch_request:read fetch-request.auth:read"
