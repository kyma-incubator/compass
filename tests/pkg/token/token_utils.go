...
const (
	...
	IntegrationSystemScopes                          = "application.local_tenant_id:write webhook:write application:read application.webhooks:read application:write application_template:read application_template:write runtime:read runtime:write integration_system:read label_definition:read label_definition:write automatic_scenario_assignment:read integration_system.auths:read application_template.webhooks:read internal_visibility:read application.auths:read formation:write"
