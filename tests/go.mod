...
require (
	...
	github.com/kyma-incubator/compass/components/director v0.0.0-20230810161455-7bbd74f1badd
	github.com/kyma-incubator/compass/components/external-services-mock v0.0.0-20230810161455-7bbd74f1badd
