...
require (
	...
	github.com/kyma-incubator/compass/components/director v0.0.0-20240513062657-4025eec03e10
...
require (
	...
	github.com/kyma-incubator/compass/components/system-broker v0.0.0-20240429124008-273ce1ffbcfd // indirect
