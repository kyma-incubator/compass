...
require (
	...
	github.com/kyma-incubator/compass/components/director v0.0.0-20230210120000-a2e87f49f78c
	github.com/kyma-incubator/compass/components/external-services-mock v0.0.0-20230210120000-a2e87f49f78c
