...
require (
	...
	github.com/kyma-incubator/compass/components/director v0.0.0-20240228080407-8b13fcdbc6d4
...
require (
	...
	github.com/kyma-incubator/compass/components/hydrator v0.0.0-20240123081221-34fb1f6bc126 // indirect
