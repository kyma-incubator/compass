...
func addAPIToBundleWithInput(t *testing.T, ctx context.Context, gqlClient *gcli.Client, bundleID, tenant string, input graphql.APIDefinitionInput) graphql.APIDefinitionExt {
