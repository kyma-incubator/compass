...
func TestGetDefaultRuntimeForEventingForApplication_DefaultBehaviourWhenNoEventingAssigned(t *testing.T) {
	...
	defer unregisterRuntimeWithinTenant(t, runtime1.ID, testTenants.defaultTenant())
	...
	defer unregisterRuntimeWithinTenant(t, runtime2.ID, testTenants.defaultTenant())
...
func TestGetEventingConfigurationForRuntime(t *testing.T) {
	...
	defer unregisterRuntimeWithinTenant(t, runtime.ID, testTenants.defaultTenant())
