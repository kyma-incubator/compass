...
func fixDefaultTenants() []*graphql.Tenant {
	return []*graphql.Tenant{
		...
		fixTenant("9ca034f1-11ab-5b25-b76f-dc77106f571d", "bar"),
		fixTenant("af9f84a9-1d3a-4d9f-ae0c-94f883b33b6e", "foobar"),
		fixTenant("2bf03de1-23b1-4063-9d3e-67096800accc", "foobaz"),
	}
}
