...
require (
	...
	github.com/kyma-incubator/compass/components/director v0.0.0-20210217135916-96c764b34f76
	github.com/kyma-incubator/compass/tests/connector-tests v0.0.0-20210111103459-2ce2dc25a7de
	github.com/kyma-incubator/compass/tests/director v0.0.0-20210217135916-96c764b34f76
