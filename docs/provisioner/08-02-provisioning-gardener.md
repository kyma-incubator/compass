...
<div tabs name="Provisioning" group="Provisioning-Gardener">
  ...
  5. Make a call to the Runtime Provisioner to create a cluster on GCP. Note, that the Runtime Agent component (`compass-runtime-agent`) in the Kyma configuration is mandatory.
  ...
  5. Make a call to the Runtime Provisioner to create a cluster on Azure. Note, that the Runtime Agent component (`compass-runtime-agent`) in the Kyma configuration is mandatory.
  ...
  5. Make a call to the Runtime Provisioner to create a cluster on AWS. Note, that the Runtime Agent component (`compass-runtime-agent`) in the Kyma configuration is mandatory.
