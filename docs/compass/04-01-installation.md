...
If custom domains and certificates are needed, see the [Set Up Your Custom Domain TLS Certificate](https://github.com/kyma-project/kyma/blob/2.16.1/docs/03-tutorials/00-security/sec-01-tls-certificates-security.md) document in the Kyma installation guide, as well as the resources in the [Certificate Management](#certificate-management) section in this document.
