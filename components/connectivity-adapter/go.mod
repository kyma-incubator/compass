...
require (
	...
	github.com/kyma-incubator/compass/components/connector v0.0.0-20221021075309-f6a4c48ab83f
	github.com/kyma-incubator/compass/components/director v0.0.0-20221027144037-9863742d5e22
