...
require (
	...
	github.com/kyma-incubator/compass/components/connector v0.0.0-20220104100601-c864205e9ba5
	github.com/kyma-incubator/compass/components/director v0.0.0-20220930080835-58c3ff368bd1
