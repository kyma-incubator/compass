...
func TestHandler_Create(t *testing.T) {
	...
	t.Run("Error when creating service", func(t *testing.T) {
		...
		mockClient.On("CreateBundle", mock.Anything, mock.Anything).Return("", testErr)
	...
	t.Run("Error when writing legacy service reference", func(t *testing.T) {
		...
		mockContextProvider := automock.RequestContextProvider{}
		mockClient := automock.DirectorClient{}
		mockClient.On("CreateBundle", mock.Anything, mock.Anything).Return("test", nil)
		mockContextProvider.On("ForRequest", mock.Anything).
			Return(service.RequestContext{AppID: "test", DirectorClient: &mockClient}, nil)
...
func TestHandler_Get(t *testing.T) {
	...
	t.Run("Error when service not found", func(t *testing.T) {
		...
		mockContextProvider := automock.RequestContextProvider{}
		mockClient := automock.DirectorClient{}
		mockClient.On("GetBundle", mock.Anything, mock.Anything).Return(graphql.BundleExt{}, apperrors.NotFound("test"))
	...
	t.Run("Error when fetching service", func(t *testing.T) {
		...
		mockContextProvider := automock.RequestContextProvider{}
		mockClient := automock.DirectorClient{}
		mockClient.On("GetBundle", mock.Anything, mock.Anything).Return(graphql.BundleExt{}, testErr)
	...
	t.Run("Error when converting service", func(t *testing.T) {
		...
		mockContextProvider := automock.RequestContextProvider{}
		mockClient := automock.DirectorClient{}
		mockClient.On("GetBundle", mock.Anything, mock.Anything).Return(graphql.BundleExt{}, nil)
...
func TestHandler_Update(t *testing.T) {
	...
	t.Run("Error when updating service", func(t *testing.T) {
		...
		mockClient := automock.DirectorClient{}
		mockClient.On("GetBundle", mock.Anything, mock.Anything).Return(graphql.BundleExt{}, nil)
		mockClient.On("UpdateBundle", mock.Anything, mock.Anything).Return(testErr)
		mockContextProvider.On("ForRequest", mock.Anything).
			Return(service.RequestContext{AppID: "test", DirectorClient: &mockClient}, nil)
	...
	t.Run("Error when getting bundle", func(t *testing.T) {
		...
		mockContextProvider := automock.RequestContextProvider{}
		mockClient := automock.DirectorClient{}
		mockClient.On("GetBundle", mock.Anything, mock.Anything).Return(graphql.BundleExt{}, nil).Once()
		mockClient.On("GetBundle", mock.Anything, mock.Anything).Return(graphql.BundleExt{}, testErr).Once()
		mockClient.On("UpdateBundle", mock.Anything, mock.Anything).Return(nil)
		mockContextProvider.On("ForRequest", mock.Anything).
			Return(service.RequestContext{AppID: "test", DirectorClient: &mockClient}, nil)
...
func TestHandler_Delete(t *testing.T) {
	...
	t.Run("Error when service not found", func(t *testing.T) {
		...
		mockContextProvider := automock.RequestContextProvider{}
		mockClient := automock.DirectorClient{}
		mockClient.On("DeleteBundle", mock.Anything).Return(apperrors.NotFound("test"))
		mockContextProvider.On("ForRequest", mock.Anything).
			Return(service.RequestContext{AppID: "test", DirectorClient: &mockClient}, nil)
	...
	t.Run("Error when deleting service failed", func(t *testing.T) {
		...
		mockContextProvider := automock.RequestContextProvider{}
		mockClient := automock.DirectorClient{}
		mockClient.On("DeleteBundle", mock.Anything).Return(testErr)
		mockContextProvider.On("ForRequest", mock.Anything).
			Return(service.RequestContext{AppID: "test", DirectorClient: &mockClient}, nil)
	...
	t.Run("Error when deleting legacy service reference", func(t *testing.T) {
		...
		mockContextProvider := automock.RequestContextProvider{}
		mockClient := automock.DirectorClient{}
		mockClient.On("DeleteBundle", mock.Anything).Return(nil)
		mockContextProvider.On("ForRequest", mock.Anything).
			Return(service.RequestContext{AppID: "test", DirectorClient: &mockClient}, nil)
