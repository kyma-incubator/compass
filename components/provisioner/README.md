...
Database schema needs to be updated in `./assets/database/provisioner.sql` so that tests run properly and also the new migration need to be provided in Schema Migrator component in `migrations/provisioner`.
