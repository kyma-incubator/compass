...
// Update provides a mock function with given fields: runtimeID, kubeconfig, deprovisioningContext
func (_m RuntimeService) Update(runtimeID string, kubeconfig string, deprovisioningContext string) dberrors.Error {
	ret := _m.Called(runtimeID, kubeconfig, deprovisioningContext)

	var r0 dberrors.Error
	if rf, ok := ret.Get(0).(func(string, string, string) dberrors.Error); ok {
		r0 = rf(runtimeID, kubeconfig, deprovisioningContext)
	} else {
		if ret.Get(0) != nil {
