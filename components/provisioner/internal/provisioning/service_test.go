...
func TestService_ProvisionRuntime(t *testing.T) {
	...
	inputConverter := NewInputConverter(uuid.NewUUIDGenerator(), releaseRepo, gardenerProject, defaultAutoUpdateKubernetesVersion, defaultAutoUpdateMachineImageVersion)
...
func TestService_DeprovisionRuntime(t *testing.T) {
	...
	inputConverter := NewInputConverter(uuid.NewUUIDGenerator(), nil, gardenerProject, defaultAutoUpdateKubernetesVersion, defaultAutoUpdateMachineImageVersion)
	graphQLConverter := NewGraphQLConverter()
	...
	t.Run("Should start Runtime deprovisioning and return operation ID", func(t *testing.T) {
		...
		resolver := NewProvisioningService(inputConverter, graphQLConverter, nil, sessionFactoryMock, provisioner, uuid.NewUUIDGenerator(), nil, deprovisioningQueue, nil)
	...
	t.Run("Should return error when failed to get cluster", func(t *testing.T) {
		...
		resolver := NewProvisioningService(inputConverter, graphQLConverter, nil, sessionFactoryMock, nil, uuid.NewUUIDGenerator(), nil, nil, nil)
...
func TestService_RuntimeOperationStatus(t *testing.T) {
	...
	inputConverter := NewInputConverter(uuidGenerator, nil, gardenerProject, defaultAutoUpdateKubernetesVersion, defaultAutoUpdateMachineImageVersion)
	graphQLConverter := NewGraphQLConverter()
	...
	t.Run("Should return operation status", func(t *testing.T) {
		...
		resolver := NewProvisioningService(inputConverter, graphQLConverter, nil, sessionFactoryMock, nil, uuidGenerator, nil, nil, nil)
...
func TestService_UpgradeRuntime(t *testing.T) {
	...
	t.Run("Should start runtime provisioning of Gardener cluster and return operation ID", func(t *testing.T) {
		...
		service := NewProvisioningService(inputConverter, graphQLConverter, nil, sessionFactoryMock, nil, uuidGenerator, provisioningQueue, deprovisioningQueue, upgradeQueue)
...
func TestService_RollBackLastUpgrade(t *testing.T) {
	...
	t.Run("Should start runtime provisioning of Gardener cluster and return operation ID", func(t *testing.T) {
		...
		service := NewProvisioningService(inputConverter, graphQLConverter, nil, sessionFactoryMock, nil, uuidGenerator, nil, nil, nil)
