...
type mockConstructorTestingTNewConfigChangeService interface {
	mock.TestingT
	Cleanup(func())
}

// NewConfigChangeService creates a new instance of ConfigChangeService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewConfigChangeService(t mockConstructorTestingTNewConfigChangeService) *ConfigChangeService {
