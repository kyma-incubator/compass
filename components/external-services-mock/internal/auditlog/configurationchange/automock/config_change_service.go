...
// SearchByString provides a mock function with given fields: searchString
func (_m *ConfigChangeService) SearchByString(searchString string) []model.ConfigurationChange {
