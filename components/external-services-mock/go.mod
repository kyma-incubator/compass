...
require (
	github.com/kyma-incubator/compass/components/director v0.0.0-20230222141952-48314e9ffcd4
	github.com/kyma-incubator/compass/components/gateway v0.0.0-20230222142553-aab62c1419c9
