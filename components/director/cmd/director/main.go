...
func main() {
	...
	gqlAPIRouter.Use(dataloader.HandlerSpecAPIDef(rootResolver.SpecAPIDefDataloader, cfg.DataloaderMaxBatch, cfg.DataloaderWait))
	gqlAPIRouter.Use(dataloader.HandlerSpecEventDef(rootResolver.SpecEventDefDataloader, cfg.DataloaderMaxBatch, cfg.DataloaderWait))
