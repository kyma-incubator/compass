...
func main() {
	...
	claimsValidator := claims.NewValidator(transact, runtimeSvc(cfg), runtimeCtxSvc(cfg), appTemplateSvc(), applicationSvc(cfg, httpClient, certCache), intSystemSvc(), cfg.Features.SubscriptionProviderLabelKey, cfg.Features.ConsumerSubaccountLabelKey, cfg.Features.GlobalSubaccountLabelKey, cfg.Features.TokenPrefix)
