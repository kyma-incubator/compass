...
func main() {
	...
	gqlAPIRouter.Use(dataloader.HandlerFormation(rootResolver.FormationAssignmentsDataLoader, cfg.DataloaderMaxBatch, cfg.DataloaderWait))
