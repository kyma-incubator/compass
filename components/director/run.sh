...
export APP_ASSIGNMENT_OPERATION_ASYNC_STATUS_API_ENDPOINT='/{uclFormationId}/assignments/{uclAssignmentId}/operations/{operationId}/status'
export APP_ASSIGNMENT_OPERATION_ASYNC_STATUS_RESET_API_ENDPOINT='/{uclFormationId}/assignments/{uclAssignmentId}'
