...
APP_DB_USER=${DB_USER} APP_DB_PASSWORD=${DB_PWD} APP_DB_NAME=${DB_NAME} APP_SCOPES_CONFIGURATION_FILE=${ROOT_PATH}/../../chart/compass/charts/director/scopes.yaml  APP_JWKS_SYNC_PERIOD="30m" APP_ALLOW_JWT_SIGNING_NONE='true' go run ${ROOT_PATH}/cmd/main.go
