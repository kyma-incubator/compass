...
export APP_FORMATION_API_PATH_PREFIX='/v1/formations'
export APP_ASSIGNMENT_OPERATION_ASYNC_STATUS_API_ENDPOINT='/{ucl-formation-id}/assignments/{ucl-assignment-id}/operations/{operation-id}/status'
export APP_ASSIGNMENT_OPERATION_ASYNC_STATUS_RESET_API_ENDPOINT='/{ucl-formation-id}/assignments/{ucl-assignment-id}'
