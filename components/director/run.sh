...
export APP_EXT_SVC_CLIENT_CERT_VALUE="certValue" # the default value is not valid but if you want you can override with the desired certificate value
export APP_EXT_SVC_CLIENT_KEY_VALUE="keyValue" # the default value is not valid but if you want you can override with the desired key value
export APP_EXT_SVC_CLIENT_CERT_SECRET_NAME=${EXT_SVC_CERT_SECRET_NAME}
...
export APP_SELF_REGISTER_SAAS_APP_SECRET_PATH="/tmp/appNameConfig"
...
# This file is necessary for self registration flow containing SaaS application configuration
cat <<EOF > /tmp/appNameConfig
{
  "eu-1": {
    "localSaaSAppNamePath": "SaaS-app-name-1"
  },
  "eu-2": {
    "localSaaSAppNamePath": "SaaS-app-name-2"
  }
}
EOF
