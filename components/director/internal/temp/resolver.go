...
func (r *mutationResolver) AddEvent(ctx context.Context, applicationID string, in gqlschema.EventDefinitionInput) (*gqlschema.EventAPIDefinition, error) {
	panic("not implemented")
}
func (r *mutationResolver) UpdateEvent(ctx context.Context, id string, in gqlschema.EventDefinitionInput) (*gqlschema.EventAPIDefinition, error) {
	panic("not implemented")
}
func (r *mutationResolver) DeleteEvent(ctx context.Context, id string) (*gqlschema.EventAPIDefinition, error) {
	panic("not implemented")
}
func (r *mutationResolver) RefetchEventSpec(ctx context.Context, eventID string) (*gqlschema.EventSpec, error) {
	panic("not implemented")
}
