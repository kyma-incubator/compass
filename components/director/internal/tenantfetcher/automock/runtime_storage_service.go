...
// RuntimeStorageService is an autogenerated mock type for the RuntimeStorageService type
type RuntimeStorageService struct {
	mock.Mock
}

// GetByFiltersGlobal provides a mock function with given fields: ctx, filter
func (_m *RuntimeStorageService) GetByFiltersGlobal(ctx context.Context, filter []*labelfilter.LabelFilter) (*model.Runtime, error) {
...
func (_m *RuntimeStorageService) Update(ctx context.Context, id string, in model.RuntimeInput) error {
...
func (_m *RuntimeStorageService) UpdateTenantID(ctx context.Context, runtimeID string, newTenantID string) error {
