...
//	requestBodyWithBothIDs, err := json.Marshal(TenantCreationRequest{
...
//
//	requestBodyWithTenantID, err := json.Marshal(TenantCreationRequest{
//		TenantID:   tenantExtID,
//	})
//	assert.NoError(t, err)
//
//	invalidRequestBody, err := json.Marshal(TenantCreationRequest{})
//	assert.NoError(t, err)
//
