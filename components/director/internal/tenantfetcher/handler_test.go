...
func TestService_Create(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			TenantSvcFn: func() *automock.TenantService {
				...
				tenantSvc.On("CreateManyIfNotExists", txtest.CtxWithDBMatcher(), []model.BusinessTenantMappingInput{accountTenant}).Return(nil).Once()
				return tenantSvc
			},
		...
		},
		{
			...
			TenantSvcFn: func() *automock.TenantService {
				...
				tenantSvc.On("CreateManyIfNotExists", txtest.CtxWithDBMatcher(), []model.BusinessTenantMappingInput{customerTenant}).Return(nil).Once()
				tenantSvc.On("GetInternalTenant", mock.Anything, customerTenant.ExternalTenant).Return(parentTenantIntID, nil).Once()
				tenantSvc.On("CreateManyIfNotExists", txtest.CtxWithDBMatcher(), []model.BusinessTenantMappingInput{accountTenant}).Return(nil).Once()
				return tenantSvc
			},
		...
		},
		{
			...
			TenantSvcFn: func() *automock.TenantService {
				tenantSvc := &automock.TenantService{}
				tenantSvc.On("CreateManyIfNotExists", txtest.CtxWithDBMatcher(), []model.BusinessTenantMappingInput{accountTenantWithoutParent}).Return(nil).Once()
				return tenantSvc
			},
			HandlerCfg:            validHandlerConfig,
		...
		},
		{
			...
			TenantSvcFn: func() *automock.TenantService {
				tenantSvc := &automock.TenantService{}
				tenantSvc.On("GetInternalTenant", mock.Anything, customerTenant.ExternalTenant).Return("", apperrors.NewNotFoundError(resource.Tenant, customerTenant.ExternalTenant)).Once()
				tenantSvc.On("CreateManyIfNotExists", txtest.CtxWithDBMatcher(), []model.BusinessTenantMappingInput{customerTenant}).Return(apperrors.NewNotUniqueError(resource.Tenant)).Once()
				tenantSvc.On("GetInternalTenant", mock.Anything, customerTenant.ExternalTenant).Return(parentTenantIntID, nil).Once()
				tenantSvc.On("CreateManyIfNotExists", txtest.CtxWithDBMatcher(), []model.BusinessTenantMappingInput{accountTenant}).Return(nil).Once()
				return tenantSvc
			},
		...
		},
		{
			...
			TenantSvcFn: func() *automock.TenantService {
				...
				tenantSvc.On("CreateManyIfNotExists", txtest.CtxWithDBMatcher(), []model.BusinessTenantMappingInput{customerTenant}).Return(testError).Once()
				return tenantSvc
			},
			HandlerCfg:            validHandlerConfig,
			Request:               httptest.NewRequest(http.MethodPut, target, bytes.NewBuffer(validRequestBody)),
		...
		},
		{
			...
			TenantSvcFn: func() *automock.TenantService {
				...
				tenantSvc.On("CreateManyIfNotExists", txtest.CtxWithDBMatcher(), []model.BusinessTenantMappingInput{customerTenant}).Return(apperrors.NewNotUniqueError(resource.Tenant)).Once()
				tenantSvc.On("GetInternalTenant", mock.Anything, customerTenant.ExternalTenant).Return(parentTenantIntID, nil).Once()
				tenantSvc.On("CreateManyIfNotExists", txtest.CtxWithDBMatcher(), []model.BusinessTenantMappingInput{accountTenant}).Return(testError).Once()
				return tenantSvc
			},
			HandlerCfg:          validHandlerConfig,
			Request:             httptest.NewRequest(http.MethodPut, target, bytes.NewBuffer(validRequestBody)),
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			...
			defer mock.AssertExpectationsForObjects(t, transact, tenantSvc)

			body, err := json.Marshal(customerTenant)
			require.NoError(t, err)

			handler := tenantfetcher.NewTenantsHTTPHandler(tenantSvc, transact, testCase.HandlerCfg)
...
func TestService_Delete(t *testing.T) {
	...
	t.Run("DeleteByExternalID handler is noop", func(t *testing.T) {
		...
		handler := tenantfetcher.NewTenantsHTTPHandler(tenantSvc, transact, config)
