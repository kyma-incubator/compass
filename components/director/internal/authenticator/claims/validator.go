...
func (v *validator) Validate(ctx context.Context, claims Claims) error {
	...
	log.C(ctx).Infof("Consumer-Provider call by %s on behalf of %s. Proceeding with double authentication crosscheck...", claims.Tenant[tenantmapping.ProviderTenantKey], "")
