...
func (_m *OAuthService) ListClients(ctx context.Context) ([]oauth20.Client, error) {
	ret := _m.Called(ctx)

	var r0 []oauth20.Client
	if rf, ok := ret.Get(0).(func(context.Context) []oauth20.Client); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]oauth20.Client)
		}
	}
