...
func (_m *OAuthService) GetClientDetails(objType systemauth.SystemAuthReferenceObjectType) (*oauth20.ClientDetails, error) {
	ret := _m.Called(objType)

	var r0 *oauth20.ClientDetails
	if rf, ok := ret.Get(0).(func(systemauth.SystemAuthReferenceObjectType) *oauth20.ClientDetails); ok {
		r0 = rf(objType)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(systemauth.SystemAuthReferenceObjectType) error); ok {
		r1 = rf(objType)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *OAuthService) UpdateClient(ctx context.Context, clientID string, objectType systemauth.SystemAuthReferenceObjectType) error {
