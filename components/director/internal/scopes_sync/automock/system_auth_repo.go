...
func (_m *SystemAuthRepo) ListGlobalWithConditions(ctx context.Context, conditions repo.Conditions) ([]pkgmodel.SystemAuth, error) {
	ret := _m.Called(ctx, conditions)

	var r0 []pkgmodel.SystemAuth
	if rf, ok := ret.Get(0).(func(context.Context, repo.Conditions) []pkgmodel.SystemAuth); ok {
