...
// NewGlobalProductService creates a new instance of GlobalProductService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewGlobalProductService(t testing.TB) *GlobalProductService {
