...
func (_m *APIService) Create(ctx context.Context, appId string, bundleID *string, packageID *string, in model.APIDefinitionInput, spec []*model.SpecInput) (string, error) {
	ret := _m.Called(ctx, appId, bundleID, packageID, in, spec)

	var r0 string
	if rf, ok := ret.Get(0).(func(context.Context, string, *string, *string, model.APIDefinitionInput, []*model.SpecInput) string); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, string, *string, *string, model.APIDefinitionInput, []*model.SpecInput) error); ok {
...
func (_m *APIService) Update(ctx context.Context, id string, in model.APIDefinitionInput, specIn *model.SpecInput) error {
