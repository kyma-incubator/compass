...
func (_m *TombstoneProcessor) Process(ctx context.Context, resourceType resource.Type, resourceID string, tombstones []*model.TombstoneInput) ([]*model.Tombstone, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, resource.Type, string, []*model.TombstoneInput) ([]*model.Tombstone, error)); ok {
		return rf(ctx, resourceType, resourceID, tombstones)
	}
