...
func TestValidateLabelDef(t *testing.T) {
	...
	t.Run("scenarios definition with enum value which does not meet the regex - enum value contains invalid character", func(t *testing.T) {
		// GIVEN
	...
	t.Run("scenarios definition with enum value which does not meet the regex - enum value too long", func(t *testing.T) {
		// GIVEN
		var sch interface{} = map[string]interface{}{
			"type":        "array",
			"minItems":    1,
			...
			"items": map[string]interface{}{
				"type": "string",
				"enum": []string{"DEFAULT", "Abcdefghijklmnopqrstuvwxyz1234567890Abcdefghijklmnopqrstuvwxyz1234567890Abcdefghijklmnopqrstuvwxyz1234567890Abcdefghijklmnopqrstuvwxyz1234567890"},
			},
		}
		in := model.LabelDefinition{ID: "id", Key: model.ScenariosKey, Tenant: "tenant", Schema: &sch}
		// WHEN
...
func TestValidateForUpdateLabelDef(t *testing.T) {
	...
	t.Run("scenarios definition update with enum value which does not meet the regex - enum value contains invalid character", func(t *testing.T) {
		// GIVEN
		var sch interface{} = map[string]interface{}{
			"type":        "array",
			"minItems":    1,
	...
	t.Run("scenarios definition update with enum value which does not meet the regex - enum value too long", func(t *testing.T) {
		// GIVEN
		var sch interface{} = map[string]interface{}{
			"type":        "array",
			"minItems":    1,
