...
// UpsertWithEmbeddedTenant provides a mock function with given fields: ctx, destination
func (_m *DestinationRepository) UpsertWithEmbeddedTenant(ctx context.Context, destination *model.Destination) error {
