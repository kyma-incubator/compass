...
// NewDestinationManager creates a new instance of DestinationManager. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDestinationManager(t testing.TB) *DestinationManager {
