...
// NewTenantRepo creates a new instance of TenantRepo. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewTenantRepo(t testing.TB) *TenantRepo {
	mock := &TenantRepo{}
	mock.Mock.Test(t)
