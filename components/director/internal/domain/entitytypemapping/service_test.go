...
func TestService_Update(t *testing.T) {
	...
	testCases := []struct {
		...
		InputResourceType       resource.Type
		InputID                 string
		EntityTypeMappingInput  model.EntityTypeMappingInput
		EntityTypeMappingRepoFn func() *automock.EntityTypeMappingRepository
		ExpectedError           error
		ExpectedOutput          string
	}{
		{
			...
			EntityTypeMappingInput: fixEntityTypeMappingInputModel(),
			EntityTypeMappingRepoFn: func() *automock.EntityTypeMappingRepository {
				entityTypeRepo := &automock.EntityTypeMappingRepository{}
		...
		{
			Name:                   "fail while getting entity type by id for API",
			InputResourceType:      resource.API,
			InputID:                entityTypeMappingID,
			EntityTypeMappingInput: fixEntityTypeMappingInputModel(),
			EntityTypeMappingRepoFn: func() *automock.EntityTypeMappingRepository {
		...
		{
			Name:                   "fail while getting entity type by id for Event",
			InputResourceType:      resource.EventDefinition,
			InputID:                entityTypeMappingID,
			EntityTypeMappingInput: fixEntityTypeMappingInputModel(),
			EntityTypeMappingRepoFn: func() *automock.EntityTypeMappingRepository {
		...
		{
			Name:                   "fail while updating entity type for API",
			InputResourceType:      resource.API,
			InputID:                entityTypeMappingID,
			EntityTypeMappingInput: fixEntityTypeMappingInputModel(),
			EntityTypeMappingRepoFn: func() *automock.EntityTypeMappingRepository {
		...
		{
			Name:                   "fail while updating entity type for Event",
			InputResourceType:      resource.EventDefinition,
			InputID:                entityTypeMappingID,
			EntityTypeMappingInput: fixEntityTypeMappingInputModel(),
			EntityTypeMappingRepoFn: func() *automock.EntityTypeMappingRepository {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			...
			// WHEN
			err := svc.Update(ctx, testCase.InputResourceType, testCase.InputID, testCase.EntityTypeMappingInput)
...
func TestService_Exists(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			EntityTypeMappingRepoFn: func() *automock.EntityTypeMappingRepository {
				entityTypeRepo := &automock.EntityTypeMappingRepository{}
				entityTypeRepo.On("Exists", ctx, tenantID, entityTypeMappingID).Return(true, nil).Once()
				return entityTypeRepo
			},
			ExpectedOutput: true,
		},
		{
			...
			EntityTypeMappingRepoFn: func() *automock.EntityTypeMappingRepository {
				entityTypeRepo := &automock.EntityTypeMappingRepository{}
				entityTypeRepo.On("Exists", ctx, tenantID, entityTypeMappingID).Return(false, nil).Once()
				return entityTypeRepo
			},
		...
		},
		{
			...
			EntityTypeMappingRepoFn: func() *automock.EntityTypeMappingRepository {
				entityTypeRepo := &automock.EntityTypeMappingRepository{}
				entityTypeRepo.On("Exists", ctx, tenantID, entityTypeMappingID).Return(false, errTest).Once()
				return entityTypeRepo
			},
			ExpectedError: errTest,
		},
