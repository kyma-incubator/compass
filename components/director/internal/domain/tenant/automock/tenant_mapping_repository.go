...
// NewTenantMappingRepository creates a new instance of TenantMappingRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewTenantMappingRepository(t testing.TB) *TenantMappingRepository {
