...
// ListSubaccounts provides a mock function with given fields: ctx
func (_m *TenantMappingRepository) ListSubaccounts(ctx context.Context) ([]*model.BusinessTenantMapping, error) {
	ret := _m.Called(ctx)
