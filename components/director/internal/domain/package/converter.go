...
func (c *converter) FromEntity(entity *Entity) (*model.Package, error) {
	...
	output := &model.Package{
		...
		RuntimeRestriction:           repo.StringPtrFromNullableString(entity.RuntimeRestriction),
