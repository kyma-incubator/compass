...
func fixAPIDefinitionColumns() []string {
	return []string{"id", "app_id", "package_id", "name", "description", "group_name", "ord_id",
		...
		"custom_implementation_standard_description", "target_urls", "extensible", "successors", "resource_hash", "hierarchy", "documentation_labels"}
}
...
func fixAPIDefinitionRow(id, placeholder string) []driver.Value {
	...
	return []driver.Value{id, appID, packageID, placeholder, "desc_" + placeholder, "group_" + placeholder,
		...
		repo.NewValidNullableString(extensible), repo.NewValidNullableString(successors), repo.NewValidNullableString(resourceHash), repo.NewValidNullableString("[]"), repo.NewValidNullableString("[]")}
}
...
func fixAPICreateArgs(id string, apiDef *model.APIDefinition) []driver.Value {
	return []driver.Value{id, appID, packageID, apiDef.Name, apiDef.Description, apiDef.Group,
		...
		repo.NewNullableStringFromJSONRawMessage(apiDef.Successors), apiDef.ResourceHash, repo.NewNullableStringFromJSONRawMessage(apiDef.Hierarchy), repo.NewNullableStringFromJSONRawMessage(apiDef.DocumentationLabels)}
}
