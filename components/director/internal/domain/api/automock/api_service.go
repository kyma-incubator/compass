...
func (_m *APIService) Create(ctx context.Context, id string, applicationID string, in model.APIDefinitionInput) (string, error) {
	ret := _m.Called(ctx, id, applicationID, in)

	var r0 string
	if rf, ok := ret.Get(0).(func(context.Context, string, string, model.APIDefinitionInput) string); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, string, string, model.APIDefinitionInput) error); ok {
