...
// RuntimeAuthService is an autogenerated mock type for the RuntimeAuthService type
type RuntimeAuthService struct {
	mock.Mock
}

// Delete provides a mock function with given fields: ctx, apiID, runtimeID
func (_m *RuntimeAuthService) Delete(ctx context.Context, apiID string, runtimeID string) error {
...
func (_m *RuntimeAuthService) Get(ctx context.Context, apiID string, runtimeID string) (*model.RuntimeAuth, error) {
	ret := _m.Called(ctx, apiID, runtimeID)
...
func (_m *RuntimeAuthService) GetOrDefault(ctx context.Context, apiID string, runtimeID string) (*model.RuntimeAuth, error) {
	ret := _m.Called(ctx, apiID, runtimeID)
...
func (_m *RuntimeAuthService) ListForAllRuntimes(ctx context.Context, apiID string) ([]model.RuntimeAuth, error) {
	ret := _m.Called(ctx, apiID)

	var r0 []model.RuntimeAuth
	if rf, ok := ret.Get(0).(func(context.Context, string) []model.RuntimeAuth); ok {
		r0 = rf(ctx, apiID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.RuntimeAuth)
...
func (_m *RuntimeAuthService) Set(ctx context.Context, apiID string, runtimeID string, in model.AuthInput) error {
