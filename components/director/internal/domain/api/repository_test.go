...
func TestPgRepository_GetByID(t *testing.T) {
	...
	suite := testdb.RepoGetTestSuite{
		...
		SQLQueryDetails: []testdb.SQLQueryDetails{
			{
				Query:    regexp.QuoteMeta(`SELECT id, app_id, app_template_version_id, package_id, name, description, group_name, ord_id, local_tenant_id, short_description, system_instance_aware, policy_level, custom_policy_level, api_protocol, tags, countries, links, api_resource_links, release_status, sunset_date, changelog_entries, labels, visibility, disabled, part_of_products, line_of_business, industry, version_value, version_deprecated, version_deprecated_since, version_for_removal, ready, created_at, updated_at, deleted_at, error, implementation_standard, custom_implementation_standard, custom_implementation_standard_description, target_urls, extensible, successors, resource_hash, supported_use_cases, documentation_labels, correlation_ids, direction FROM "public"."api_definitions" WHERE id = $1 AND (id IN (SELECT id FROM api_definitions_tenants WHERE tenant_id = $2))`),
...
func TestPgRepository_GetByIDGlobal(t *testing.T) {
	...
	suite := testdb.RepoGetTestSuite{
		...
		SQLQueryDetails: []testdb.SQLQueryDetails{
			{
				Query:    regexp.QuoteMeta(`SELECT id, app_id, app_template_version_id, package_id, name, description, group_name, ord_id, local_tenant_id, short_description, system_instance_aware, policy_level, custom_policy_level, api_protocol, tags, countries, links, api_resource_links, release_status, sunset_date, changelog_entries, labels, visibility, disabled, part_of_products, line_of_business, industry, version_value, version_deprecated, version_deprecated_since, version_for_removal, ready, created_at, updated_at, deleted_at, error, implementation_standard, custom_implementation_standard, custom_implementation_standard_description, target_urls, extensible, successors, resource_hash, supported_use_cases, documentation_labels, correlation_ids, direction FROM "public"."api_definitions" WHERE id = $1`),
...
func TestPgRepository_ListByResourceID(t *testing.T) {
	...
	suiteForApplication := testdb.RepoListTestSuite{
		...
		SQLQueryDetails: []testdb.SQLQueryDetails{
			{
				Query:    regexp.QuoteMeta(`SELECT id, app_id, app_template_version_id, package_id, name, description, group_name, ord_id, local_tenant_id, short_description, system_instance_aware, policy_level, custom_policy_level, api_protocol, tags, countries, links, api_resource_links, release_status, sunset_date, changelog_entries, labels, visibility, disabled, part_of_products, line_of_business, industry, version_value, version_deprecated, version_deprecated_since, version_for_removal, ready, created_at, updated_at, deleted_at, error, implementation_standard, custom_implementation_standard, custom_implementation_standard_description, target_urls, extensible, successors, resource_hash, supported_use_cases, documentation_labels, correlation_ids, direction FROM "public"."api_definitions" WHERE app_id = $1 AND (id IN (SELECT id FROM api_definitions_tenants WHERE tenant_id = $2)) FOR UPDATE`),
	...
	suiteForApplicationTemplateVersion := testdb.RepoListTestSuite{
		...
		SQLQueryDetails: []testdb.SQLQueryDetails{
			{
				Query: regexp.QuoteMeta(`SELECT id, app_id, app_template_version_id, package_id, name, description, group_name, ord_id, local_tenant_id, short_description, system_instance_aware, policy_level, custom_policy_level, api_protocol, tags, countries, links, api_resource_links, release_status, sunset_date, changelog_entries, labels, visibility, disabled, part_of_products, line_of_business, industry, version_value, version_deprecated, version_deprecated_since, version_for_removal, ready, created_at, updated_at, deleted_at, error, implementation_standard, custom_implementation_standard, custom_implementation_standard_description, target_urls, extensible, successors, resource_hash, supported_use_cases, documentation_labels, correlation_ids, direction FROM "public"."api_definitions" WHERE app_template_version_id = $1
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     FOR UPDATE`),
...
func TestPgRepository_ListByApplicationIDPage(t *testing.T) {
	...
	suite := testdb.RepoListPageableTestSuite{
		...
		SQLQueryDetails: []testdb.SQLQueryDetails{
			{
				Query:    regexp.QuoteMeta(`SELECT id, app_id, app_template_version_id, package_id, name, description, group_name, ord_id, local_tenant_id, short_description, system_instance_aware, policy_level, custom_policy_level, api_protocol, tags, countries, links, api_resource_links, release_status, sunset_date, changelog_entries, labels, visibility, disabled, part_of_products, line_of_business, industry, version_value, version_deprecated, version_deprecated_since, version_for_removal, ready, created_at, updated_at, deleted_at, error, implementation_standard, custom_implementation_standard, custom_implementation_standard_description, target_urls, extensible, successors, resource_hash, supported_use_cases, documentation_labels, correlation_ids, direction FROM "public"."api_definitions" WHERE (app_id = $1 AND (id IN (SELECT id FROM api_definitions_tenants WHERE tenant_id = $2)))`),
				Args:     []driver.Value{appID, tenantID},
				IsSelect: true,
				ValidRowsProvider: func() []*sqlmock.Rows {
...
func TestPgRepository_ListAllForBundle(t *testing.T) {
	...
	suite := testdb.RepoListPageableTestSuite{
		...
		SQLQueryDetails: []testdb.SQLQueryDetails{
			{
				Query:    regexp.QuoteMeta(`SELECT id, app_id, app_template_version_id, package_id, name, description, group_name, ord_id, local_tenant_id, short_description, system_instance_aware, policy_level, custom_policy_level, api_protocol, tags, countries, links, api_resource_links, release_status, sunset_date, changelog_entries, labels, visibility, disabled, part_of_products, line_of_business, industry, version_value, version_deprecated, version_deprecated_since, version_for_removal, ready, created_at, updated_at, deleted_at, error, implementation_standard, custom_implementation_standard, custom_implementation_standard_description, target_urls, extensible, successors, resource_hash, supported_use_cases, documentation_labels, correlation_ids, direction FROM "public"."api_definitions" WHERE id IN ($1, $2) AND (id IN (SELECT id FROM api_definitions_tenants WHERE tenant_id = $3))`),
...
func TestPgRepository_Update(t *testing.T) {
	updateQuery := regexp.QuoteMeta(`UPDATE "public"."api_definitions" SET package_id = ?, name = ?, description = ?, group_name = ?, ord_id = ?, local_tenant_id = ?,
		...
		target_urls = ?, extensible = ?, successors = ?, resource_hash = ?, supported_use_cases = ?, documentation_labels = ?, correlation_ids = ?, direction = ?
		...
		SQLQueryDetails: []testdb.SQLQueryDetails{
			{
				...
				Args: []driver.Value{entity.PackageID, entity.Name, entity.Description, entity.Group,
					...
					entity.TargetURLs, entity.Extensible, entity.Successors, entity.ResourceHash, entity.SupportedUseCases, entity.DocumentationLabels, entity.CorrelationIDs, entity.Direction, entity.ID, tenantID},
				ValidResult:   sqlmock.NewResult(-1, 1),
		...
		SQLQueryDetails: []testdb.SQLQueryDetails{
			{
				...
				Args: []driver.Value{entity.PackageID, entity.Name, entity.Description, entity.Group,
					...
					entity.Version.DeprecatedSince, entity.Version.ForRemoval, entity.Ready, entity.CreatedAt, entity.UpdatedAt, entity.DeletedAt,
					entity.Error, entity.ImplementationStandard, entity.CustomImplementationStandard, entity.CustomImplementationStandardDescription,
					entity.TargetURLs, entity.Extensible, entity.Successors, entity.ResourceHash, entity.SupportedUseCases, entity.DocumentationLabels, entity.CorrelationIDs, entity.Direction, entity.ID},
				ValidResult:   sqlmock.NewResult(-1, 1),
				InvalidResult: sqlmock.NewResult(-1, 0),
			},
		},
