...
var (
	...
	apiDefColumns = []string{"id", "app_id", "app_template_version_id", "package_id", "name", "description", "group_name", "ord_id", "local_tenant_id",
		...
		"implementation_standard", "custom_implementation_standard", "custom_implementation_standard_description", "target_urls", "extensible", "successors", "resource_hash", "supported_use_cases",
		"documentation_labels", "correlation_ids", "direction", "last_update", "deprecation_date", "responsible", "usage"}
	idColumns        = []string{"id"}
