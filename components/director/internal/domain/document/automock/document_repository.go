...
// NewDocumentRepository creates a new instance of DocumentRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDocumentRepository(t testing.TB) *DocumentRepository {
