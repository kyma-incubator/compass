...
func (_m *Service) CreateClientCredentials(ctx context.Context, objectType pkgmodel.SystemAuthReferenceObjectType) (*model.OAuthCredentialDataInput, error) {
	ret := _m.Called(ctx, objectType)

	var r0 *model.OAuthCredentialDataInput
	if rf, ok := ret.Get(0).(func(context.Context, pkgmodel.SystemAuthReferenceObjectType) *model.OAuthCredentialDataInput); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, pkgmodel.SystemAuthReferenceObjectType) error); ok {
