...
func (_m *TokenService) GenerateOneTimeToken(ctx context.Context, runtimeID string, tokenType pkgmodel.SystemAuthReferenceObjectType) (*model.OneTimeToken, error) {
	ret := _m.Called(ctx, runtimeID, tokenType)

	var r0 *model.OneTimeToken
	if rf, ok := ret.Get(0).(func(context.Context, string, pkgmodel.SystemAuthReferenceObjectType) *model.OneTimeToken); ok {
