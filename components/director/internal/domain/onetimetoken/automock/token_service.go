...
func (_m *TokenService) GenerateOneTimeToken(ctx context.Context, runtimeID string, tokenType pubModel.SystemAuthReferenceObjectType) (*model.OneTimeToken, error) {
	ret := _m.Called(ctx, runtimeID, tokenType)

	var r0 *model.OneTimeToken
	if rf, ok := ret.Get(0).(func(context.Context, string, pubModel.SystemAuthReferenceObjectType) *model.OneTimeToken); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, string, pubModel.SystemAuthReferenceObjectType) error); ok {
