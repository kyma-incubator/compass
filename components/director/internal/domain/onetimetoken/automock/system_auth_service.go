...
func (_m *SystemAuthService) Create(ctx context.Context, objectType pkgmodel.SystemAuthReferenceObjectType, objectID string, authInput *model.AuthInput) (string, error) {
	ret := _m.Called(ctx, objectType, objectID, authInput)

	var r0 string
	if rf, ok := ret.Get(0).(func(context.Context, pkgmodel.SystemAuthReferenceObjectType, string, *model.AuthInput) string); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, pkgmodel.SystemAuthReferenceObjectType, string, *model.AuthInput) error); ok {
...
func (_m *SystemAuthService) GetGlobal(ctx context.Context, authID string) (*pkgmodel.SystemAuth, error) {
