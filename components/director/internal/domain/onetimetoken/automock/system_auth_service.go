...
// GetByID provides a mock function with given fields: ctx, authID
func (_m *SystemAuthService) GetByID(ctx context.Context, authID string) (*model.SystemAuth, error) {
