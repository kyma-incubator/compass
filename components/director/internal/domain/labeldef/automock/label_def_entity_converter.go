...
type LabelDefEntityConverter struct {
	mock.Mock
}

// FromEntity provides a mock function with given fields: in
func (_m *LabelDefEntityConverter) FromEntity(in labeldef.Entity) (model.LabelDefinition, error) {
	ret := _m.Called(in)
...
func (_m *LabelDefEntityConverter) ToEntity(in model.LabelDefinition) (labeldef.Entity, error) {
	ret := _m.Called(in)
