...
// ExistsOwned checks if runtime with given id in given tenant exists and have owner=true
func (r *pgRepository) ExistsOwned(ctx context.Context, tenant, id string) (bool, error) {
