	...
	testCases := []struct {
	...
	}{
		{
			...
			SysAuthServiceFn: func() *automock.SystemAuthService {
				...
				svc.On("ListForObject", contextParam, pubModel.RuntimeReference, modelRuntime.ID).Return(testAuths, nil)
				return svc
			},
			OAuth20ServiceFn: func() *automock.OAuth20Service {
		...
		},
		{
			...
			SysAuthServiceFn: func() *automock.SystemAuthService {
				svc := &automock.SystemAuthService{}
				svc.On("ListForObject", contextParam, pubModel.RuntimeReference, modelRuntime.ID).Return(nil, testErr)
				return svc
			},
			OAuth20ServiceFn: func() *automock.OAuth20Service {
				svc := &automock.OAuth20Service{}
	...
	testCases := []struct {
	...
	}{
		{
			...
			SysAuthSvcFn: func() *automock.SystemAuthService {
				...
				sysAuthSvc.On("ListForObject", txtest.CtxWithDBMatcher(), pubModel.RuntimeReference, parentRuntime.ID).Return(modelSysAuths, nil).Once()
				return sysAuthSvc
			},
			SysAuthConvFn: func() *automock.SystemAuthConverter {
		...
		},
		{
			...
			SysAuthSvcFn: func() *automock.SystemAuthService {
				sysAuthSvc := &automock.SystemAuthService{}
				sysAuthSvc.On("ListForObject", txtest.CtxWithDBMatcher(), pubModel.RuntimeReference, parentRuntime.ID).Return(nil, testErr).Once()
				return sysAuthSvc
			},
			SysAuthConvFn: func() *automock.SystemAuthConverter {
				sysAuthConv := &automock.SystemAuthConverter{}
