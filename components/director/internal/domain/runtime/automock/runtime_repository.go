...
func (_m *RuntimeRepository) List(filter []*labelfilter.LabelFilter, pageSize *int, cursor *string) (*runtime.RuntimePage, error) {
	ret := _m.Called(filter, pageSize, cursor)

	var r0 *runtime.RuntimePage
	if rf, ok := ret.Get(0).(func([]*labelfilter.LabelFilter, *int, *string) *runtime.RuntimePage); ok {
