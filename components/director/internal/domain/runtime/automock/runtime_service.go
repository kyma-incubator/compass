...
// CreateWithMandatoryLabels provides a mock function with given fields: ctx, in, mandatoryLabels
func (_m *RuntimeService) CreateWithMandatoryLabels(ctx context.Context, in model.RuntimeInput, mandatoryLabels map[string]interface{}) (string, error) {
	ret := _m.Called(ctx, in, mandatoryLabels)

	var r0 string
	if rf, ok := ret.Get(0).(func(context.Context, model.RuntimeInput, map[string]interface{}) string); ok {
		r0 = rf(ctx, in, mandatoryLabels)
	} else {
		r0 = ret.Get(0).(string)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, model.RuntimeInput, map[string]interface{}) error); ok {
		r1 = rf(ctx, in, mandatoryLabels)
	} else {
		r1 = ret.Error(1)
	}
