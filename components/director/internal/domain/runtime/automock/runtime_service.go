...
// CleanupSelfRegisteredRuntimeAfterFailedRegistration provides a mock function with given fields: ctx, in
func (_m *RuntimeService) CleanupSelfRegisteredRuntimeAfterFailedRegistration(ctx context.Context, in model.RuntimeInput) {
	_m.Called(ctx, in)
}

// CleanupSelfRegistrationAfterRuntimeDeletion provides a mock function with given fields: ctx, runtimeID
func (_m *RuntimeService) CleanupSelfRegistrationAfterRuntimeDeletion(ctx context.Context, runtimeID string) {
	_m.Called(ctx, runtimeID)
}
