...
import runtime "github.com/kyma-incubator/compass/components/director/internal/domain/runtime"
...
func (_m *RuntimeService) List(ctx context.Context, filter []*labelfilter.LabelFilter, pageSize *int, cursor *string) (*runtime.RuntimePage, error) {
	ret := _m.Called(ctx, filter, pageSize, cursor)

	var r0 *runtime.RuntimePage
	if rf, ok := ret.Get(0).(func(context.Context, []*labelfilter.LabelFilter, *int, *string) *runtime.RuntimePage); ok {
		r0 = rf(ctx, filter, pageSize, cursor)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*runtime.RuntimePage)
		}
	}
