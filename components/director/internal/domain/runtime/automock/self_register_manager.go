...
func (_m *SelfRegisterManager) PrepareRuntimeForSelfRegistration(ctx context.Context, in model.RuntimeInput) (map[string]interface{}, error) {
	ret := _m.Called(ctx, in)

	var r0 map[string]interface{}
	if rf, ok := ret.Get(0).(func(context.Context, model.RuntimeInput) map[string]interface{}); ok {
		r0 = rf(ctx, in)
	} else {
		if ret.Get(0) != nil {
