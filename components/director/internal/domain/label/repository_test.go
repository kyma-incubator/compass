...
func TestRepository_ListGlobalByKeyAndObjects(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		...
		escapedQuery := regexp.QuoteMeta(`SELECT FOR UPDATE id, tenant_id, app_id, runtime_id, runtime_context_id, key, value, version FROM public.labels WHERE key = $1 AND app_id IN ($2, $3, $4)`)
