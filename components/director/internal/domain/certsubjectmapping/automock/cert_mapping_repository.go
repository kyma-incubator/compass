...
// NewCertMappingRepository creates a new instance of CertMappingRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewCertMappingRepository(t testing.TB) *CertMappingRepository {
