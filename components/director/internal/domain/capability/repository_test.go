...
func TestPgRepository_ListByResourceID(t *testing.T) {
	...
	suiteForApplication := testdb.RepoListTestSuite{
		...
		SQLQueryDetails: []testdb.SQLQueryDetails{
			{
				Query:    regexp.QuoteMeta(`SELECT id, app_id, app_template_version_id, package_id, name, description, ord_id, type, custom_type, local_tenant_id, short_description, system_instance_aware, tags, links, release_status, labels, visibility, version_value, version_deprecated, version_deprecated_since, version_for_removal, ready, created_at, updated_at, deleted_at, error, resource_hash, documentation_labels, correlation_ids FROM "public"."capabilities" WHERE app_id = $1 AND (id IN (SELECT id FROM capabilities_tenants WHERE tenant_id = $2)) FOR UPDATE`),
	...
	suiteForApplicationTemplateVersion := testdb.RepoListTestSuite{
		...
		SQLQueryDetails: []testdb.SQLQueryDetails{
			{
				Query:    regexp.QuoteMeta(`SELECT id, app_id, app_template_version_id, package_id, name, description, ord_id, type, custom_type, local_tenant_id, short_description, system_instance_aware, tags, links, release_status, labels, visibility, version_value, version_deprecated, version_deprecated_since, version_for_removal, ready, created_at, updated_at, deleted_at, error, resource_hash, documentation_labels, correlation_ids FROM "public"."capabilities" WHERE app_template_version_id = $1 FOR UPDATE`),
...
func TestPgRepository_GetByID(t *testing.T) {
	...
	suite := testdb.RepoGetTestSuite{
		...
		SQLQueryDetails: []testdb.SQLQueryDetails{
			{
				Query:    regexp.QuoteMeta(`SELECT id, app_id, app_template_version_id, package_id, name, description, ord_id, type, custom_type, local_tenant_id, short_description, system_instance_aware, tags, links, release_status, labels, visibility, version_value, version_deprecated, version_deprecated_since, version_for_removal, ready, created_at, updated_at, deleted_at, error, resource_hash, documentation_labels, correlation_ids FROM "public"."capabilities" WHERE id = $1 AND (id IN (SELECT id FROM capabilities_tenants WHERE tenant_id = $2))`),
...
func TestPgRepository_GetByIDGlobal(t *testing.T) {
	...
	suite := testdb.RepoGetTestSuite{
		...
		SQLQueryDetails: []testdb.SQLQueryDetails{
			{
				Query:    regexp.QuoteMeta(`SELECT id, app_id, app_template_version_id, package_id, name, description, ord_id, type, custom_type, local_tenant_id, short_description, system_instance_aware, tags, links, release_status, labels, visibility, version_value, version_deprecated, version_deprecated_since, version_for_removal, ready, created_at, updated_at, deleted_at, error, resource_hash, documentation_labels, correlation_ids FROM "public"."capabilities" WHERE id = $1`),
...
func TestPgRepository_Update(t *testing.T) {
	updateQuery := regexp.QuoteMeta(`UPDATE "public"."capabilities" SET package_id = ?, name = ?, description = ?, ord_id = ?, type = ?, custom_type = ?, local_tenant_id = ?,
		...
		updated_at = ?, deleted_at = ?, error = ?, resource_hash = ?, documentation_labels = ?, correlation_ids = ?
		...
		SQLQueryDetails: []testdb.SQLQueryDetails{
			{
				...
				Args: []driver.Value{entity.PackageID, entity.Name, entity.Description,
					...
					entity.Error, entity.ResourceHash, entity.DocumentationLabels, entity.CorrelationIDs, entity.ID, tenantID},
				ValidResult:   sqlmock.NewResult(-1, 1),
		...
		SQLQueryDetails: []testdb.SQLQueryDetails{
			{
				...
				Args: []driver.Value{entity.PackageID, entity.Name, entity.Description,
					...
					entity.Version.Value, entity.Version.Deprecated,
					entity.Version.DeprecatedSince, entity.Version.ForRemoval, entity.Ready, entity.CreatedAt, entity.UpdatedAt, entity.DeletedAt,
					entity.Error, entity.ResourceHash, entity.DocumentationLabels, entity.CorrelationIDs, entity.ID},
				ValidResult:   sqlmock.NewResult(-1, 1),
				InvalidResult: sqlmock.NewResult(-1, 0),
			},
		},
