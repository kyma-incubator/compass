...
// GetForSelector provides a mock function with given fields: ctx, in, tenantID
func (_m *Repository) GetForSelector(ctx context.Context, in model.LabelSelector, tenantID string) ([]*model.AutomaticScenarioAssignment, error) {
