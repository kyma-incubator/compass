...
// NewScenariosDefService creates a new instance of ScenariosDefService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewScenariosDefService(t testing.TB) *ScenariosDefService {
