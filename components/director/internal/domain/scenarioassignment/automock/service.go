...
// DeleteForSelector provides a mock function with given fields: ctx, selector
func (_m *Service) DeleteForSelector(ctx context.Context, selector model.LabelSelector) error {
	ret := _m.Called(ctx, selector)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, model.LabelSelector) error); ok {
		r0 = rf(ctx, selector)
	} else {
		r0 = ret.Error(0)
	}
...
// DeleteForScenarioName provides a mock function with given fields: ctx, scenarioName
func (_m *Service) DeleteForScenarioName(ctx context.Context, scenarioName string) error {
...
// GetForSelector provides a mock function with given fields: ctx, in
func (_m *Service) GetForSelector(ctx context.Context, in model.LabelSelector) ([]*model.AutomaticScenarioAssignment, error) {
	ret := _m.Called(ctx, in)
