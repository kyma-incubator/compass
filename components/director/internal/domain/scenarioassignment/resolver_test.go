...
func TestResolverCreateAutomaticScenarioAssignment(t *testing.T) {
	...
	t.Run("happy path", func(t *testing.T) {
		...
		sut := scenarioassignment.NewResolver(transact, mockSvc, mockConverter, tenantSvc, fetcherSvc)
		...
		mock.AssertExpectationsForObjects(t, tx, transact, mockSvc, mockConverter, tenantSvc, fetcherSvc)
	})
	...
	t.Run("error when tenant creation fail", func(t *testing.T) {
		...
		sut := scenarioassignment.NewResolver(transact, nil, nil, nil, fetcherSvc)
	...
	t.Run("error when tenant conversion fail", func(t *testing.T) {
		...
		sut := scenarioassignment.NewResolver(transact, nil, nil, tenantSvc, fetcherSvc)
...
func TestResolver_GetAutomaticScenarioAssignmentByScenario(t *testing.T) {
	...
	t.Run("happy path", func(t *testing.T) {
		...
		sut := scenarioassignment.NewResolver(transact, mockSvc, mockConverter, tenantSvc, nil)
	...
	t.Run("error when GetExternalTenant fail", func(t *testing.T) {
		...
		sut := scenarioassignment.NewResolver(transact, mockSvc, nil, tenantSvc, nil)
	...
	t.Run("error on starting transaction", func(t *testing.T) {
		...
		sut := scenarioassignment.NewResolver(transact, nil, nil, nil, nil)
	...
	t.Run("error on receiving assignment by service", func(t *testing.T) {
		...
		sut := scenarioassignment.NewResolver(transact, mockSvc, nil, nil, nil)
...
func TestResolver_AutomaticScenarioAssignmentsForSelector(t *testing.T) {
	...
	t.Run("error on getting assignments by service", func(t *testing.T) {
		...
		sut := scenarioassignment.NewResolver(transact, nil, nil, tenantSvc, nil)
...
func TestResolver_AutomaticScenarioAssignments(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			...
			resolver := scenarioassignment.NewResolver(transact, svc, converter, tenantSvc, nil)
