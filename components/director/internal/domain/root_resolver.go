...
func NewRootResolver(
	...
	appSvc := application.NewService(appNameNormalizer, cfgProvider, selfRegConfig.SelfRegisterDistinguishLabelKey, applicationRepo, webhookRepo, runtimeRepo, labelRepo, intSysRepo, labelSvc, labelDefSvc, bundleSvc, uidSvc)
