...
func NewRootResolver(
	...
	runtimeSvc := runtime.NewService(runtimeRepo, labelRepo, labelDefSvc, labelSvc, uidSvc, scenarioAssignmentEngine, rtmConfig, featuresConfig.ProtectedLabelPattern)
