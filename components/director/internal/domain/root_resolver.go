...
func NewRootResolver(
	...
	return &RootResolver{
		...
		appTemplate:         apptemplate.NewResolver(transact, appSvc, appConverter, appTemplateSvc, appTemplateConverter, webhookSvc, webhookConverter, selfRegisterManager, uidSvc, certSubjectMappingSvc, labelSvc, appTemplateProductLabel),
