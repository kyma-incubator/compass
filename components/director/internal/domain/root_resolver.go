...
func NewRootResolver(
	...
	formationSvc := formation.NewService(labelConverter, labelDefRepo, labelRepo, uidSvc, labelDefSvc)
	...
	runtimeSvc := runtime.NewService(runtimeRepo, labelRepo, labelDefSvc, labelUpsertSvc, uidSvc, scenarioAssignmentEngine, featuresConfig.ProtectedLabelPattern)
	...
	appSvc := application.NewService(appNameNormalizer, cfgProvider, applicationRepo, webhookRepo, runtimeRepo, labelRepo, intSysRepo, labelUpsertSvc, labelDefSvc, bundleSvc, uidSvc)
