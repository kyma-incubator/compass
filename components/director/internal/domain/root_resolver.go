...
func (r *queryResolver) Applications(ctx context.Context, filter []*graphql.LabelFilter, first *int, after *scalars.PageCursor) (*graphql.ApplicationPage, error) {
...
func (r *queryResolver) Runtimes(ctx context.Context, filter []*graphql.LabelFilter, first *int, after *scalars.PageCursor) (*graphql.RuntimePage, error) {
...
func (r *queryResolver) HealthChecks(ctx context.Context, types []graphql.HealthCheckType, origin *string, first *int, after *scalars.PageCursor) (*graphql.HealthCheckPage, error) {
...
func (r *applicationResolver) Apis(ctx context.Context, obj *graphql.Application, group *string, first *int, after *scalars.PageCursor) (*graphql.APIDefinitionPage, error) {
	return r.app.Apis(ctx, obj, group, first, after)
}
func (r *applicationResolver) EventAPIs(ctx context.Context, obj *graphql.Application, group *string, first *int, after *scalars.PageCursor) (*graphql.EventAPIDefinitionPage, error) {
	return r.app.EventAPIs(ctx, obj, group, first, after)
}
func (r *applicationResolver) Documents(ctx context.Context, obj *graphql.Application, first *int, after *scalars.PageCursor) (*graphql.DocumentPage, error) {
