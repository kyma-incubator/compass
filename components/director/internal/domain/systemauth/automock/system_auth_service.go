...
func (_m *SystemAuthService) DeleteByIDForObject(ctx context.Context, objectType systemauth.SystemAuthReferenceObjectType, authID string) error {
	ret := _m.Called(ctx, objectType, authID)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, systemauth.SystemAuthReferenceObjectType, string) error); ok {
...
func (_m *SystemAuthService) GetGlobal(ctx context.Context, id string) (*systemauth.SystemAuth, error) {
...
func (_m *SystemAuthService) InvalidateToken(ctx context.Context, id string) (*systemauth.SystemAuth, error) {
	ret := _m.Called(ctx, id)
