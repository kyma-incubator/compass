...
func (_m *SystemAuthService) DeleteByIDForObject(ctx context.Context, objectType pubModel.SystemAuthReferenceObjectType, authID string) error {
	ret := _m.Called(ctx, objectType, authID)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, pubModel.SystemAuthReferenceObjectType, string) error); ok {
...
func (_m *SystemAuthService) GetByToken(ctx context.Context, token string) (*pubModel.SystemAuth, error) {
...
func (_m *SystemAuthService) GetGlobal(ctx context.Context, id string) (*pubModel.SystemAuth, error) {
...
func (_m *SystemAuthService) InvalidateToken(ctx context.Context, id string) (*pubModel.SystemAuth, error) {
	ret := _m.Called(ctx, id)
...
func (_m *SystemAuthService) Update(ctx context.Context, item *pubModel.SystemAuth) error {
...
func (_m *SystemAuthService) UpdateValue(ctx context.Context, id string, item *model.Auth) (*pubModel.SystemAuth, error) {
	ret := _m.Called(ctx, id, item)

	var r0 *pubModel.SystemAuth
	if rf, ok := ret.Get(0).(func(context.Context, string, *model.Auth) *pubModel.SystemAuth); ok {
		r0 = rf(ctx, id, item)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*pubModel.SystemAuth)
