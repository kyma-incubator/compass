...
// PrepareApplicationCreateInputJSON provides a mock function with given fields: appTemplate, templatePlaceholderValues
func (_m *ApplicationTemplateService) PrepareApplicationCreateInputJSON(appTemplate *model.ApplicationTemplate, templatePlaceholderValues []*model.ApplicationTemplateValueInput) (string, error) {
	ret := _m.Called(appTemplate, templatePlaceholderValues)

	var r0 string
	if rf, ok := ret.Get(0).(func(*model.ApplicationTemplate, []*model.ApplicationTemplateValueInput) string); ok {
		r0 = rf(appTemplate, templatePlaceholderValues)
	} else {
		r0 = ret.Get(0).(string)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(*model.ApplicationTemplate, []*model.ApplicationTemplateValueInput) error); ok {
		r1 = rf(appTemplate, templatePlaceholderValues)
	} else {
		r1 = ret.Error(1)
	}
