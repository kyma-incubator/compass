...
const (
	...
	appInputJSONWithAppTypeLabelString                            = `{"description":"Lorem ipsum","healthCheckURL":"https://foo.bar","integrationSystemID":"iiiiiiiii-iiii-iiii-iiii-iiiiiiiiiiii","labels":{"applicationType":"%s","test":["val","val2"]},"name":"foo","providerName":"compass","webhooks":[{"auth":null,"type":"","url":"webhook1.foo.bar"},{"auth":null,"type":"","url":"webhook2.foo.bar"}]}`
	appInputJSONWithAppTypeAndSystemRoleLabelString               = `{"description":"Lorem ipsum","healthCheckURL":"https://foo.bar","integrationSystemID":"iiiiiiiii-iiii-iiii-iiii-iiiiiiiiiiii","labels":{"applicationType":"%s","systemRole":["role"],"test":["val","val2"]},"name":"foo","providerName":"compass","webhooks":[{"auth":null,"type":"","url":"webhook1.foo.bar"},{"auth":null,"type":"","url":"webhook2.foo.bar"}]}`
	appInputJSONWithAppTypeAndSystemRoleAndDefaultSlisLabelString = `{"description":"Lorem ipsum","healthCheckURL":"https://foo.bar","integrationSystemID":"iiiiiiiii-iiii-iiii-iiii-iiiiiiiiiiii","labels":{"applicationType":"%s","slisFilter":[{"filter":[{"key":"$.additionalAttributes.managedBy","operation":"exclude","value":["SAP Cloud"]}],"productId":"role"}],"systemRole":["role"],"test":["val","val2"]},"name":"foo","providerName":"compass","webhooks":[{"auth":null,"type":"","url":"webhook1.foo.bar"},{"auth":null,"type":"","url":"webhook2.foo.bar"}]}`
