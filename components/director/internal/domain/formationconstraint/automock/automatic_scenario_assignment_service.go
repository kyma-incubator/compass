...
// NewAutomaticScenarioAssignmentService creates a new instance of AutomaticScenarioAssignmentService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewAutomaticScenarioAssignmentService(t testing.TB) *AutomaticScenarioAssignmentService {
