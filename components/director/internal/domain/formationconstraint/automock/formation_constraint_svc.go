...
// NewFormationConstraintSvc creates a new instance of FormationConstraintSvc. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewFormationConstraintSvc(t testing.TB) *FormationConstraintSvc {
