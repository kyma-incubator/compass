...
func TestConstraintOperators_IsNotAssignedToAnyFormationOfType(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			...
			engine := operators.NewConstraintEngine(nil, nil, tenantSvc, asaSvc, nil, nil, nil, formationRepo, labelRepo, nil, nil, nil, nil, nil, nil, nil, nil, runtimeType, applicationType)
			// WHEN
