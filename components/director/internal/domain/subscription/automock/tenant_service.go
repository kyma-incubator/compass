...
// GetTenantByExternalID provides a mock function with given fields: ctx, externalTenantID
func (_m *TenantService) GetTenantByExternalID(ctx context.Context, externalTenantID string) (*model.BusinessTenantMapping, error) {
