...
// NewProcessFunc creates a new instance of ProcessFunc. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewProcessFunc(t testing.TB) *ProcessFunc {
	mock := &ProcessFunc{}
	mock.Mock.Test(t)
