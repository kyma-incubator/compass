...
// NewConstraintEngine creates a new instance of ConstraintEngine. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewConstraintEngine(t testing.TB) *ConstraintEngine {
