...
// LabelConverter is an autogenerated mock type for the LabelConverter type
type LabelConverter struct {
	mock.Mock
}

// FromEntity provides a mock function with given fields: in
func (_m *LabelConverter) FromEntity(in label.Entity) (model.Label, error) {
	ret := _m.Called(in)
...
func (_m *LabelConverter) ToEntity(in model.Label) (label.Entity, error) {
	ret := _m.Called(in)
