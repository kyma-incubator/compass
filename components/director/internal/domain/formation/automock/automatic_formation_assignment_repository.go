...
func (_m *AutomaticFormationAssignmentRepository) GetForScenarioName(ctx context.Context, tenantID string, scenarioName string) (model.AutomaticScenarioAssignment, error) {
	ret := _m.Called(ctx, tenantID, scenarioName)
...
func (_m *AutomaticFormationAssignmentRepository) List(ctx context.Context, tenant string, pageSize int, cursor string) (*model.AutomaticScenarioAssignmentPage, error) {
...
func (_m *AutomaticFormationAssignmentRepository) ListForTargetTenant(ctx context.Context, tenantID string, targetTenantID string) ([]*model.AutomaticScenarioAssignment, error) {
	ret := _m.Called(ctx, tenantID, targetTenantID)
