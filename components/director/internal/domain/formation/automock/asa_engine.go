...
// NewAsaEngine creates a new instance of AsaEngine. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewAsaEngine(t testing.TB) *AsaEngine {
	mock := &AsaEngine{}
	mock.Mock.Test(t)
