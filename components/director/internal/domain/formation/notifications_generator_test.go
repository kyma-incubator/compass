	...
	testCases := []struct {
	...
	}{
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithLabels, runtimeCtx2WithLabels, emptyFormationAssignment, emptyFormationAssignment, model.ApplicationResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, ApplicationID, model.ApplicationWebhookReference)).Return(appNotificationWithRtmCtxRtmIDAndTemplate, nil).Once()

				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithRtmCtxWithLabels, runtimeCtxWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.ApplicationResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, ApplicationID, model.ApplicationWebhookReference)).Return(appNotificationWithRtmCtxAndTemplate, nil).Once()
		...
		},
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithLabels, runtimeCtx2WithLabels, emptyFormationAssignment, emptyFormationAssignment, model.ApplicationResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, ApplicationTemplateID, model.ApplicationTemplateWebhookReference)).Return(appNotificationWithRtmCtxRtmIDAndTemplate, nil).Once()

				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithRtmCtxWithLabels, runtimeCtxWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.ApplicationResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, ApplicationTemplateID, model.ApplicationTemplateWebhookReference)).Return(appNotificationWithRtmCtxAndTemplate, nil).Once()
		...
		{
			Name: "success - when generating notification results in notification not generated",
			WebhookRepoFN: func() *automock.WebhookRepository {
				repo := &automock.WebhookRepository{}
				repo.On("GetByIDAndWebhookType", ctx, TntInternalID, ApplicationID, model.ApplicationWebhookReference, model.WebhookTypeConfigurationChanged).Return(fixConfigurationChangedWebhookModel(WebhookID, ApplicationID, model.ApplicationWebhookReference), nil).Once()
				return repo
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithLabels, runtimeCtx2WithLabels, emptyFormationAssignment, emptyFormationAssignment, model.ApplicationResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, ApplicationID, model.ApplicationWebhookReference)).Return(nil, nil).Once()
		...
		},
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithLabels, runtimeCtx2WithLabels, emptyFormationAssignment, emptyFormationAssignment, model.ApplicationResourceType, customerTenantContext, TntInternalID).Return(nil, testErr).Once()

				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithRtmCtxWithLabels, runtimeCtxWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.ApplicationResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Maybe()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, ApplicationID, model.ApplicationWebhookReference)).Return(appNotificationWithRtmCtxAndTemplate, nil).Maybe()
	...
	testCases := []struct {
	...
	}{
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithLabels, emptyRuntimeContextWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.RuntimeResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, RuntimeID, model.RuntimeWebhookReference)).Return(runtimeNotificationWithAppTemplate, nil).Once()

				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithRtmCtxWithLabels, runtimeCtxWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.RuntimeResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookForRuntimeContextID, RuntimeContextRuntimeID, model.RuntimeWebhookReference)).Return(runtimeNotificationWithRtmCtxAndAppTemplate, nil).Once()
		...
		{
			Name: "success - when generating notification results in not generated notification",
			WebhookRepoFN: func() *automock.WebhookRepository {
				repo := &automock.WebhookRepository{}
				repo.On("ListByReferenceObjectTypeAndWebhookType", ctx, TntInternalID, model.WebhookTypeConfigurationChanged, model.RuntimeWebhookReference).Return([]*model.Webhook{fixConfigurationChangedWebhookModel(WebhookID, RuntimeID, model.RuntimeWebhookReference), fixConfigurationChangedWebhookModel(WebhookForRuntimeContextID, RuntimeContextRuntimeID, model.RuntimeWebhookReference)}, nil).Once()
				return repo
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithLabels, emptyRuntimeContextWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.RuntimeResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, RuntimeID, model.RuntimeWebhookReference)).Return(nil, nil).Once()
		...
		{
			Name: "error when generating notification",
			WebhookRepoFN: func() *automock.WebhookRepository {
				repo := &automock.WebhookRepository{}
				repo.On("ListByReferenceObjectTypeAndWebhookType", ctx, TntInternalID, model.WebhookTypeConfigurationChanged, model.RuntimeWebhookReference).Return([]*model.Webhook{fixConfigurationChangedWebhookModel(WebhookID, RuntimeID, model.RuntimeWebhookReference)}, nil).Once()
				return repo
			},
			DataInputBuilder: func() *databuilderautomock.DataInputBuilder {
				dataInputBuilder := &databuilderautomock.DataInputBuilder{}
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithLabels, emptyRuntimeContextWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.RuntimeResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, RuntimeID, model.RuntimeWebhookReference)).Return(nil, testErr).Once()
		...
		},
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithLabels, emptyRuntimeContextWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.RuntimeResourceType, customerTenantContext, TntInternalID).Return(nil, testErr).Once()

				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithRtmCtxWithLabels, runtimeCtxWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.RuntimeResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Maybe()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookForRuntimeContextID, RuntimeContextRuntimeID, model.RuntimeWebhookReference)).Return(runtimeNotificationWithRtmCtxAndAppTemplate, nil).Maybe()
	...
	testCases := []struct {
	...
	}{
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForApplicationTenantMappingNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, emptyAppTemplateWithLabels, appWithLabelsWithoutTemplate2, appTemplateWithLabels, appWithLabels, emptyFormationAssignment, emptyFormationAssignment, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixApplicationTenantMappingWebhookModel(WebhookID, ApplicationID)).Return(appToAppNotificationWithoutSourceTemplateWithTargetTemplate, nil).Once()

				notificationsBuilder.On("PrepareDetailsForApplicationTenantMappingNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, emptyAppTemplateWithLabels, appWithLabelsWithoutTemplate2, emptyFormationAssignment, emptyFormationAssignment, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixApplicationTenantMappingWebhookModel(Webhook2ID, Application2ID)).Return(appToAppNotificationWithSourceTemplateWithoutTargetTemplate, nil).Once()
		...
		},
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForApplicationTenantMappingNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels2, applicationsMappingWithApplicationTemplate[Application2ID], appTemplateWithLabels, appWithLabels, emptyFormationAssignment, emptyFormationAssignment, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixApplicationTenantMappingWebhookModel(WebhookID, ApplicationID)).Return(appToAppNotificationWithSourceAndTargetTemplatesSwaped, nil).Once()

				notificationsBuilder.On("PrepareDetailsForApplicationTenantMappingNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, appTemplateWithLabels2, applicationsMappingWithApplicationTemplate[Application2ID], emptyFormationAssignment, emptyFormationAssignment, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixApplicationTenantMappingWebhookModel(Webhook2ID, Application2ID)).Return(appToAppNotificationWithSourceAndTargetTemplates, nil).Once()
		...
		},
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForApplicationTenantMappingNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, emptyAppTemplateWithLabels, appWithLabelsWithoutTemplate2, appTemplateWithLabels, appWithLabels, emptyFormationAssignment, emptyFormationAssignment, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixApplicationTenantMappingWebhookModel(WebhookID, ApplicationTemplateID)).Return(appToAppNotificationWithoutSourceTemplateWithTargetTemplate, nil).Once()
		...
		{
			Name: "success - while generating notification for currently assigned application results in skipping generating the notification",
			ApplicationRepoFN: func() *automock.ApplicationRepository {
				repo := &automock.ApplicationRepository{}
				repo.On("ListListeningApplications", ctx, TntInternalID, model.WebhookTypeApplicationTenantMapping).Return(listeningApplications, nil).Once()
				return repo
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForApplicationTenantMappingNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, emptyAppTemplateWithLabels, appWithLabelsWithoutTemplate2, appTemplateWithLabels, appWithLabels, emptyFormationAssignment, emptyFormationAssignment, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixApplicationTenantMappingWebhookModel(WebhookID, ApplicationID)).Return(nil, nil).Once()
		...
		{
			Name: "success - while generating notification for already assigned application results in skipping generating the notification",
			ApplicationRepoFN: func() *automock.ApplicationRepository {
				repo := &automock.ApplicationRepository{}
				repo.On("ListListeningApplications", ctx, TntInternalID, model.WebhookTypeApplicationTenantMapping).Return(listeningApplications, nil).Once()
				return repo
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForApplicationTenantMappingNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, emptyAppTemplateWithLabels, appWithLabelsWithoutTemplate2, emptyFormationAssignment, emptyFormationAssignment, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixApplicationTenantMappingWebhookModel(Webhook2ID, Application2ID)).Return(nil, nil).Once()
		...
		},
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForApplicationTenantMappingNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, emptyAppTemplateWithLabels, appWithLabelsWithoutTemplate2, emptyFormationAssignment, emptyFormationAssignment, customerTenantContext, TntInternalID).Return(nil, testErr).Once()
	...
	testCases := []struct {
	...
	}{
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, emptyAppTemplateWithLabels, appWithLabelsWithoutTemplate2, runtimeWithRtmCtxWithLabels, emptyRuntimeContextWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.ApplicationResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(Webhook2ID, Application2ID, model.ApplicationWebhookReference)).Return(appNotificationWithRtmCtxWithoutTemplate, nil).Once()
		...
		},
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithRtmCtxWithLabels, emptyRuntimeContextWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.ApplicationResourceType, customerTenantContext, TntInternalID).Return(nil, testErr).Once()

				// the method we are testing iterates over map, so it is not certain whether this will be invoked or not
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, emptyAppTemplateWithLabels, appWithLabelsWithoutTemplate2, runtimeWithRtmCtxWithLabels, emptyRuntimeContextWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.ApplicationResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Maybe()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(Webhook2ID, Application2ID, model.ApplicationWebhookReference)).Return(appNotificationWithRtmCtxWithoutTemplate, nil).Maybe()
	...
	testCases := []struct {
	...
	}{
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithLabels, emptyRuntimeContextWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.ApplicationResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, ApplicationID, model.ApplicationWebhookReference)).Return(applicationNotificationWithAppTemplate, nil).Once()

				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, emptyAppTemplateWithLabels, appWithLabelsWithoutTemplate, runtimeWithLabels, emptyRuntimeContextWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.ApplicationResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(Webhook2ID, Application2ID, model.ApplicationWebhookReference)).Return(applicationNotificationWithoutAppTemplate, nil)
		...
		},
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithLabels, emptyRuntimeContextWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.ApplicationResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, ApplicationTemplateID, model.ApplicationTemplateWebhookReference)).Return(applicationNotificationWithAppTemplate, nil).Once()
		...
		},
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, emptyAppTemplateWithLabels, appWithLabelsWithoutTemplate, runtimeWithLabels, emptyRuntimeContextWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.ApplicationResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(Webhook2ID, Application2ID, model.ApplicationWebhookReference)).Return(nil, nil).Once()
		...
		},
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithLabels, emptyRuntimeContextWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.ApplicationResourceType, customerTenantContext, TntInternalID).Return(nil, testErr).Once()

				// the method we are testing iterates over map, so it is not certain whether this will be invoked or not
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, emptyAppTemplateWithLabels, appWithLabelsWithoutTemplate, runtimeWithLabels, emptyRuntimeContextWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.ApplicationResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Maybe()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(Webhook2ID, Application2ID, model.ApplicationWebhookReference)).Return(applicationNotificationWithoutAppTemplate, nil).Maybe()
	...
	testCases := []struct {
	...
	}{
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithRtmCtxWithLabels, runtimeCtxWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.RuntimeContextResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, RuntimeContextRuntimeID, model.RuntimeWebhookReference)).Return(runtimeCtxNotificationWithAppTemplate, nil).Once()

				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, emptyAppTemplateWithLabels, appWithLabelsWithoutTemplate, runtimeWithRtmCtxWithLabels, runtimeCtxWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.RuntimeContextResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, RuntimeContextRuntimeID, model.RuntimeWebhookReference)).Return(runtimeCtxNotificationWithoutAppTemplate, nil).Once()
		...
		},
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithRtmCtxWithLabels, runtimeCtxWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.RuntimeContextResourceType, customerTenantContext, TntInternalID).Return(nil, testErr).Once()

				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, emptyAppTemplateWithLabels, appWithLabelsWithoutTemplate, runtimeWithRtmCtxWithLabels, runtimeCtxWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.RuntimeContextResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Maybe()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, RuntimeContextRuntimeID, model.RuntimeWebhookReference)).Return(runtimeCtxNotificationWithoutAppTemplate, nil).Maybe()
		...
		},
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, appTemplateWithLabels, appWithLabels, runtimeWithRtmCtxWithLabels, runtimeCtxWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.RuntimeContextResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, RuntimeContextRuntimeID, model.RuntimeWebhookReference)).Return(nil, nil).Once()
	...
	testCases := []struct {
	...
	}{
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, emptyAppTemplateWithLabels, appWithLabelsWithoutTemplate, runtimeWithLabels, emptyRuntimeContextWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.RuntimeResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Once()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, RuntimeID, model.RuntimeWebhookReference)).Return(runtimeNotificationWithoutAppTemplate, nil).Once()
		...
		},
		{
			...
			NotificationsBuilder: func() *automock.NotificationBuilder {
				...
				notificationsBuilder.On("PrepareDetailsForConfigurationChangeNotificationGeneration", model.AssignFormation, FormationTemplateID, formationModelWithoutError, emptyAppTemplateWithLabels, appWithLabelsWithoutTemplate, runtimeWithLabels, emptyRuntimeContextWithLabels, emptyFormationAssignment, emptyFormationAssignment, model.RuntimeResourceType, customerTenantContext, TntInternalID).Return(notificationDetails, nil).Maybe()
				notificationsBuilder.On("BuildFormationAssignmentNotificationRequest", ctx, notificationDetails, fixConfigurationChangedWebhookModel(WebhookID, RuntimeID, model.RuntimeWebhookReference)).Return(runtimeNotificationWithoutAppTemplate, nil).Maybe()
