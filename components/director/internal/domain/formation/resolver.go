...
type formationAssignmentService interface {
	...
	ProcessFormationAssignments(ctx context.Context, formationAssignmentsForObject []*model.FormationAssignmentWithOperation, requests []*webhookclient.FormationAssignmentNotificationRequestTargetMapping, operation func(context.Context, *formationassignment.AssignmentMappingPairWithOperation) (bool, error), formationOperation model.FormationOperation) error
