...
type PackageService interface {
	...
	CreateMultiple(ctx context.Context, applicationID string, in []*model.PackageInput) error
}
...
type PackageConverter interface {
	...
	MultipleCreateInputFromGraphQL(in []*graphql.PackageInput) ([]*model.PackageInput, error)
}
