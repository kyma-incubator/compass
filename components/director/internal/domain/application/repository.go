...
var (
	applicationColumns = []string{"id", "tenant_id", "name", "description", "status_condition", "status_timestamp", "healthcheck_url", "integration_system_id", "provider_display_name"}
...
func NewRepository(conv EntityConverter) *pgRepository {
	return &pgRepository{
		...
		updater:         repo.NewUpdater(applicationTable, []string{"name", "description", "status_condition", "status_timestamp", "healthcheck_url", "integration_system_id", "provider_display_name"}, tenantColumn, []string{"id"}),
		conv:            conv,
	}
}
