...
// GetForApplication provides a mock function with given fields: ctx, appID
func (_m *EventingService) GetForApplication(ctx context.Context, appID uuid.UUID) (*model.ApplicationEventingConfiguration, error) {
