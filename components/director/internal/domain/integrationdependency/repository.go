...
var (
	...
	integrationDependencyColumns = []string{"id", "app_id", "app_template_version_id", "ord_id", "local_tenant_id", "correlation_ids", "name", "short_description", "description", "package_id", "last_update", "visibility",
		"release_status", "sunset_date", "successors", "mandatory", "aspects", "related_integration_dependencies", "links", "tags", "labels", "documentation_labels", "version_value", "version_deprecated", "version_deprecated_since", "version_for_removal",
