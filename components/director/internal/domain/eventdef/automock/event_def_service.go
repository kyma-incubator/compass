...
// NewEventDefService creates a new instance of EventDefService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewEventDefService(t testing.TB) *EventDefService {
