...
// Create provides a mock function with given fields: ctx, packageID, in, auth, requestInputSchema
func (_m *Service) Create(ctx context.Context, packageID string, in model.PackageInstanceAuthRequestInput, auth *model.Auth, requestInputSchema *string) (string, error) {
	ret := _m.Called(ctx, packageID, in, auth, requestInputSchema)

	var r0 string
	if rf, ok := ret.Get(0).(func(context.Context, string, model.PackageInstanceAuthRequestInput, *model.Auth, *string) string); ok {
		r0 = rf(ctx, packageID, in, auth, requestInputSchema)
	} else {
		r0 = ret.Get(0).(string)
	}
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, model.PackageInstanceAuthRequestInput, *model.Auth, *string) error); ok {
		r1 = rf(ctx, packageID, in, auth, requestInputSchema)
	} else {
		r1 = ret.Error(1)
	}
