	...
	testCases := []struct {
	...
	}{
		{
			...
			SysAuthSvcFn: func() *automock.SystemAuthService {
				...
				svc.On("ListForObject", txtest.CtxWithDBMatcher(), pubModel.IntegrationSystemReference, modelIntSys.ID).Return(testAuths, nil)
				return svc
			},
			OAuth20SvcFn: func() *automock.OAuth20Service {
		...
		},
		{
			...
			SysAuthSvcFn: func() *automock.SystemAuthService {
				svc := &automock.SystemAuthService{}
				svc.On("ListForObject", txtest.CtxWithDBMatcher(), pubModel.IntegrationSystemReference, modelIntSys.ID).Return(nil, testError)
				return svc
			},
			OAuth20SvcFn: func() *automock.OAuth20Service {
				svc := &automock.OAuth20Service{}
...
func TestResolver_Auths(t *testing.T) {
	...
	modelSysAuths := []pubModel.SystemAuth{
	...
	testCases := []struct {
	...
	}{
		{
			...
			SysAuthSvcFn: func() *automock.SystemAuthService {
				...
				sysAuthSvc.On("ListForObject", txtest.CtxWithDBMatcher(), pubModel.IntegrationSystemReference, parentIntegrationSystem.ID).Return(modelSysAuths, nil).Once()
				return sysAuthSvc
			},
			SysAuthConvFn: func() *automock.SystemAuthConverter {
		...
		},
		{
			...
			SysAuthSvcFn: func() *automock.SystemAuthService {
				sysAuthSvc := &automock.SystemAuthService{}
				sysAuthSvc.On("ListForObject", txtest.CtxWithDBMatcher(), pubModel.IntegrationSystemReference, parentIntegrationSystem.ID).Return(nil, testError).Once()
				return sysAuthSvc
			},
			SysAuthConvFn: func() *automock.SystemAuthConverter {
				sysAuthConv := &automock.SystemAuthConverter{}
