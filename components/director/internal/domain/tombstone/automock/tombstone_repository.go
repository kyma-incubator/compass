...
// NewTombstoneRepository creates a new instance of TombstoneRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewTombstoneRepository(t testing.TB) *TombstoneRepository {
