...
func TestStatusService_UpdateWithConstraints(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			...
			// WHEN
			err := svc.UpdateWithConstraints(testCase.Context, testCase.NotificationResponse, testCase.FormationAssignment, assignOperation)
...
func TestUpdater_SetAssignmentToErrorState(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			...
			// WHEN
			err := svc.SetAssignmentToErrorStateWithConstraints(testCase.Context, testCase.NotificationResponse, testCase.FormationAssignment, errorMsg, formationassignment.TechnicalError, model.DeleteErrorAssignmentState, assignOperation)
...
func TestStatusService_DeleteWithConstraints(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			...
			// WHEN
			err := svc.DeleteWithConstraints(testCase.Context, testCase.InputID, testCase.NotificationResponse)
