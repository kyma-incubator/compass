...
func (_m *StatusService) DeleteWithConstraints(ctx context.Context, id string, notificationResponse *statusresponse.NotificationStatusReport) error {
	ret := _m.Called(ctx, id, notificationResponse)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *statusresponse.NotificationStatusReport) error); ok {
...
func (_m *StatusService) SetAssignmentToErrorStateWithConstraints(ctx context.Context, notificationResponse *statusresponse.NotificationStatusReport, assignment *model.FormationAssignment, errorMessage string, errorCode formationassignment.AssignmentErrorCode, state model.FormationAssignmentState, operation model.FormationOperation) error {
	ret := _m.Called(ctx, notificationResponse, assignment, errorMessage, errorCode, state, operation)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *statusresponse.NotificationStatusReport, *model.FormationAssignment, string, formationassignment.AssignmentErrorCode, model.FormationAssignmentState, model.FormationOperation) error); ok {
...
func (_m *StatusService) UpdateWithConstraints(ctx context.Context, notificationResponse *statusresponse.NotificationStatusReport, fa *model.FormationAssignment, operation model.FormationOperation) error {
	ret := _m.Called(ctx, notificationResponse, fa, operation)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *statusresponse.NotificationStatusReport, *model.FormationAssignment, model.FormationOperation) error); ok {
