...
func fixFormationAssignmentsWithObjectTypeAndID(objectType model.FormationAssignmentType, objectID, appID, rtmID, rtmCtxID string) []*model.FormationAssignment {
	return []*model.FormationAssignment{
		...
		},
		{
			...
			LastOperation:              "assign",
			LastOperationInitiator:     appID,
			LastOperationInitiatorType: model.FormationAssignmentTypeApplication,
			State:                      string(model.InitialAssignmentState),
			Value:                      nil,
		},
		{
		...
		},
		{
			...
			TargetType:                 objectType,
			LastOperation:              "assign",
			LastOperationInitiator:     rtmID,
			LastOperationInitiatorType: model.FormationAssignmentTypeRuntime,
			State:                      string(model.InitialAssignmentState),
			Value:                      nil,
		},
		{
		...
		},
		{
			...
			TargetType:                 objectType,
			LastOperation:              "assign",
			LastOperationInitiator:     rtmCtxID,
			LastOperationInitiatorType: model.FormationAssignmentTypeRuntimeContext,
			State:                      string(model.InitialAssignmentState),
			Value:                      nil,
		},
	}
