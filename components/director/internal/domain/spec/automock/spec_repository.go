...
func (_m *SpecRepository) Create(ctx context.Context, item *model.Spec) error {
...
func (_m *SpecRepository) Delete(ctx context.Context, tenant string, id string) error {
...
func (_m *SpecRepository) Exists(ctx context.Context, tenantID string, id string) (bool, error) {
...
func (_m *SpecRepository) GetByID(ctx context.Context, tenantID string, id string) (*model.Spec, error) {
	ret := _m.Called(ctx, tenantID, id)

	var r0 *model.Spec
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *model.Spec); ok {
		r0 = rf(ctx, tenantID, id)
	} else {
		if ret.Get(0) != nil {
...
func (_m *SpecRepository) Update(ctx context.Context, item *model.Spec) error {
	ret := _m.Called(ctx, item)
