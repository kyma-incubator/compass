...
// NewSpecRepository creates a new instance of SpecRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSpecRepository(t testing.TB) *SpecRepository {
	mock := &SpecRepository{}
	mock.Mock.Test(t)
