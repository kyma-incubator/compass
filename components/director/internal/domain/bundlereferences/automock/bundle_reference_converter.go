...
// NewBundleReferenceConverter creates a new instance of BundleReferenceConverter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewBundleReferenceConverter(t testing.TB) *BundleReferenceConverter {
