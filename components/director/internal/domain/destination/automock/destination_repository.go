...
// NewDestinationRepository creates a new instance of DestinationRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDestinationRepository(t testing.TB) *DestinationRepository {
