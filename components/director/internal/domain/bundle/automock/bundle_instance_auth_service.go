...
// NewBundleInstanceAuthService creates a new instance of BundleInstanceAuthService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewBundleInstanceAuthService(t testing.TB) *BundleInstanceAuthService {
