...
// NewEventConverter creates a new instance of EventConverter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewEventConverter(t testing.TB) *EventConverter {
	mock := &EventConverter{}
	mock.Mock.Test(t)
