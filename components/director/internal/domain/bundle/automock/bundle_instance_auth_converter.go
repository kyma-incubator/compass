...
// NewBundleInstanceAuthConverter creates a new instance of BundleInstanceAuthConverter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewBundleInstanceAuthConverter(t testing.TB) *BundleInstanceAuthConverter {
