...
func TestResolver_AddWebhook(t *testing.T) {
	...
	modelWebhook := fixApplicationModelWebhookWithProxy(id, givenAppID, givenTenant(), "foo", time.Time{})
...
func TestResolver_UpdateWebhook(t *testing.T) {
	...
	modelWebhook := fixApplicationModelWebhookWithProxy(givenWebhookID, applicationID, givenTenant(), "foo", time.Time{})
