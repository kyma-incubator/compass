...
func TestService_ListForApplication(t *testing.T) {
	...
	modelWebhooks := []*model.Webhook{
		fixApplicationModelWebhookWithProxy("1", "foo", "Foo", time.Time{}),
		fixApplicationModelWebhookWithProxy("2", "bar", "Bar", time.Time{}),
	}
	applicationID := "foo"
...
func TestService_ListAllApplicationWebhooks(t *testing.T) {
	...
	appModelWebhooks := []*model.Webhook{
		fixApplicationModelWebhookWithType("app-webhook-1", "app-1", "test-url-1.com", model.WebhookTypeRegisterApplication, time.Time{}),
		fixApplicationModelWebhookWithType("app-webhook-2", "app-1", "test-url-2.com", model.WebhookTypeDeleteApplication, time.Time{}),
	}
...
func TestService_Update(t *testing.T) {
	...
	applicationWebhookModel := fixApplicationModelWebhookWithProxy("1", id, url, time.Time{})
