...
func (_m *Service) GetByToken(ctx context.Context, token string) (*model.SystemAuth, error) {
...
func (_m *Service) InvalidateToken(ctx context.Context, item *model.SystemAuth) error {
