...
type mockConstructorTestingTNewFormationStatusService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewFormationStatusService(t mockConstructorTestingTNewFormationStatusService) *FormationStatusService {
