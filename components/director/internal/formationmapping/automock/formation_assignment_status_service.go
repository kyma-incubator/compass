...
func (_m *FormationAssignmentStatusService) DeleteWithConstraints(ctx context.Context, id string, notificationResponse *statusresponse.NotificationResponse) error {
...
func (_m *FormationAssignmentStatusService) SetAssignmentToErrorStateWithConstraints(ctx context.Context, notificationResponse *statusresponse.NotificationResponse, assignment *model.FormationAssignment, errorMessage string, errorCode formationassignment.AssignmentErrorCode, state model.FormationAssignmentState, operation model.FormationOperation) error {
...
func (_m *FormationAssignmentStatusService) UpdateWithConstraints(ctx context.Context, notificationResponse *statusresponse.NotificationResponse, fa *model.FormationAssignment, operation model.FormationOperation) error {
