...
type DirectorGraphQLClient interface {
	...
	SubscribeTenantToRuntime(ctx context.Context, runtimeID string, subaccountID string, region string) error
	UnsubscribeTenantFromRuntime(ctx context.Context, runtimeID string, subaccountID string, region string) error
}
