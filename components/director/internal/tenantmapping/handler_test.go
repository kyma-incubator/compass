...
func TestHandler(t *testing.T) {
	...
	t.Run("success for the request parsed as JWT flow", func(t *testing.T) {
		...
		expectedRespPayload := `{"subject":"","extra":{"consumerID":"` + username + `","consumerType":"Static User","externalTenant":"` + externalTenantID + `","flow":"` + string(oathkeeper.JWTAuthFlow) + `","name":"` + username + `","scope":"` + scopes + `","tenant":"` + tenantID.String() + `"},"header":null}`
		...
		clientInstrumenter.On("InstrumentClient", username, oathkeeper.JWTAuthFlow, mock.Anything)
	...
	t.Run("success for the request parsed as JWT flow with custom authenticator", func(t *testing.T) {
		...
		expectedRespPayload := `{"subject":"","extra":{"authenticator_coordinates":{"name":"` + authn[0].Name + `","index":0},"consumerID":"` + username + `","consumerType":"Static User","externalTenant":"` + externalTenantID + `","flow":"` + string(oathkeeper.JWTAuthFlow) + `","identity":"` + username + `","scope":"` + scopes + `","tenant":"` + tenantID.String() + `","` + uniqueAttributeKey + `":"` + uniqueAttributeValue + `"},"header":null}`
	...
	t.Run("success for the request parsed as JWT flow when both normal user is present and custom authenticator are present", func(t *testing.T) {
		...
		expectedRespPayload := `{"subject":"","extra":{"authenticator_coordinates":{"name":"` + authn[0].Name + `","index":0},"consumerID":"` + username + `","consumerType":"Static User","externalTenant":"` + externalTenantID + `","flow":"` + string(oathkeeper.JWTAuthFlow) + `","identity":"` + identityUsername + `","name":"` + username + `","scope":"` + scopes + `","tenant":"` + tenantID.String() + `","` + uniqueAttributeKey + `":"` + uniqueAttributeValue + `"},"header":null}`
		...
		clientInstrumenter := &automock.ClientInstrumenter{}
		clientInstrumenter.On("InstrumentClient", identityUsername, oathkeeper.JWTAuthFlow, mock.Anything)
	...
	t.Run("success for the request parsed as OAuth2 flow", func(t *testing.T) {
		...
		expectedRespPayload := `{"subject":"","extra":{"client_id":"` + systemAuthID.String() + `","consumerID":"` + objID.String() + `","consumerType":"Integration System","externalTenant":"` + externalTenantID + `","flow":"` + string(oathkeeper.OAuth2Flow) + `","scope":"` + scopes + `","tenant":"` + tenantID.String() + `"},"header":null}`
		...
		clientInstrumenter := &automock.ClientInstrumenter{}
		clientInstrumenter.On("InstrumentClient", systemAuthID.String(), oathkeeper.OAuth2Flow, mock.Anything)
	...
	t.Run("success for the request parsed as Certificate flow for Connector issuer", func(t *testing.T) {
		...
		expectedRespPayload := `{"subject":"","extra":{"consumerID":"` + objID.String() + `","consumerType":"Integration System","externalTenant":"` + externalTenantID + `","flow":"` + string(oathkeeper.CertificateFlow) + `","scope":"` + scopes + `","tenant":"` + tenantID.String() + `"},"header":{"Client-Certificate-Issuer":["` + oathkeeper.ConnectorIssuer + `"],"Client-Id-From-Certificate":["` + systemAuthID.String() + `"]}}`
		...
		clientInstrumenter := &automock.ClientInstrumenter{}
		clientInstrumenter.On("InstrumentClient", systemAuthID.String(), oathkeeper.CertificateFlow, mock.Anything)
	...
	t.Run("success for the request parsed as Certificate flow for External issuer", func(t *testing.T) {
		...
		clientInstrumenter := &automock.ClientInstrumenter{}
		clientInstrumenter.On("InstrumentClient", externalTenantID, oathkeeper.CertificateFlow, mock.Anything)
	...
	t.Run("success for the request parsed as OneTimeToken flow", func(t *testing.T) {
		...
		expectedRespPayload := `{"subject":"","extra":{"consumerID":"` + objID.String() + `","consumerType":"Integration System","externalTenant":"` + externalTenantID + `","flow":"` + string(oathkeeper.OneTimeTokenFlow) + `","scope":"` + scopes + `","tenant":"` + tenantID.String() + `"},"header":{"Client-Id-From-Token":["` + systemAuthID.String() + `"]}}`
		...
		clientInstrumenter := &automock.ClientInstrumenter{}
		clientInstrumenter.On("InstrumentClient", systemAuthID.String(), oathkeeper.OneTimeTokenFlow, mock.Anything)
	...
	t.Run("error when transaction begin fails", func(t *testing.T) {
		...
		clientInstrumenter := &automock.ClientInstrumenter{}
		clientInstrumenter.On("InstrumentClient", "test", oathkeeper.JWTAuthFlow, mock.Anything)
