...
- [delete default eventing for application](./register-application/delete-default-eventing-for-application.graphql)
...
- [set default eventing for application](./register-application/set-default-eventing-for-application.graphql)
