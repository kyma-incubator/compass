...
require (
	...
	github.com/kyma-incubator/compass/components/connector v0.0.0-20210407183425-2a5a26c43e6c
	github.com/kyma-incubator/compass/components/operations-controller v0.0.0-20210407183425-2a5a26c43e6c
