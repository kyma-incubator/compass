...
// NewPersistenceOp creates a new instance of PersistenceOp. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewPersistenceOp(t testing.TB) *PersistenceOp {
	mock := &PersistenceOp{}
	mock.Mock.Test(t)
