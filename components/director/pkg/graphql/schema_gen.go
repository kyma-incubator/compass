...
type Mutation {
	"""
	**Examples**
	- [create application with documents](examples/register-application/create-application-with-documents.graphql)
	- [create application with event apis](examples/register-application/create-application-with-event-apis.graphql)
	- [register application with apis](examples/register-application/register-application-with-apis.graphql)
	...
	"""
	registerApplication(in: ApplicationRegisterInput!): Application! @hasScopes(path: "graphql.mutation.registerApplication")
	"""
	**Examples**
	...
	**Examples**
	...
	"""
	registerRuntime(in: RuntimeInput!): Runtime! @hasScopes(path: "graphql.mutation.registerRuntime")
	"""
	**Examples**
	...
	**Examples**
	...
	"""
	registerIntegrationSystem(in: IntegrationSystemInput!): IntegrationSystem! @hasScopes(path: "graphql.mutation.registerIntegrationSystem")
	"""
	**Examples**
	...
	**Examples**
	...
	addAPIDefinition(applicationID: ID!, in: APIDefinitionInput!): APIDefinition! @hasScopes(path: "graphql.mutation.addAPIDefinition")
	updateAPIDefinition(id: ID!, in: APIDefinitionInput!): APIDefinition! @hasScopes(path: "graphql.mutation.updateAPIDefinition")
	...
	addEventDefinition(applicationID: ID!, in: EventDefinitionInput!): EventDefinition! @hasScopes(path: "graphql.mutation.addEventDefinition")
	updateEventDefinition(id: ID!, in: EventDefinitionInput!): EventDefinition! @hasScopes(path: "graphql.mutation.updateEventDefinition")
...
func (ec *executionContext) field_Mutation_addEventDefinition_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["in"]; ok {
		arg1, err = ec.unmarshalNEventDefinitionInput2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐEventDefinitionInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_registerApplication_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["in"]; ok {
		arg0, err = ec.unmarshalNApplicationRegisterInput2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐApplicationRegisterInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Application_eventDefinitions(ctx context.Context, field graphql.CollectedField, obj *Application) (ret graphql.Marshaler) {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNEventDefinitionPage2ᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐEventDefinitionPage(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputEventDefinitionInput(ctx context.Context, obj interface{}) (EventDefinitionInput, error) {
	...
	for k, v := range asMap {
		...
		case "spec":
			var err error
			it.Spec, err = ec.unmarshalNEventSpecInput2ᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐEventSpecInput(ctx, v)
			if err != nil {
				return it, err
			}
		case "group":
...
func (ec *executionContext) marshalNEventDefinitionPage2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐEventDefinitionPage(ctx context.Context, sel ast.SelectionSet, v EventDefinitionPage) graphql.Marshaler {
	return ec._EventDefinitionPage(ctx, sel, &v)
}

func (ec *executionContext) marshalNEventDefinitionPage2ᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐEventDefinitionPage(ctx context.Context, sel ast.SelectionSet, v *EventDefinitionPage) graphql.Marshaler {
	if v == nil {
		if !ec.HasError(graphql.GetResolverContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
