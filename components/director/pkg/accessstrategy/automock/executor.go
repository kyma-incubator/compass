...
// NewExecutor creates a new instance of Executor. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewExecutor(t testing.TB) *Executor {
	mock := &Executor{}
	mock.Mock.Test(t)
