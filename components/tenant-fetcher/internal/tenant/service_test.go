	...
	testCases := []struct {
	...
	}{
		{
			...
			TenantRepoFn: func() *automock.TenantRepository {
				...
				tenantMappingRepo.On("GetByExternalID", txtest.CtxWithDBMatcher(), accountTenantWithParent.ParentExternal).Return(model.TenantModel{}, apperrors.NewNotFoundError(resource.Tenant, accountTenant.ParentExternal)).Once()
