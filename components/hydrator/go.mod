...
require (
	...
	github.com/kyma-incubator/compass/components/director v0.0.0-20220909065002-ff4629743dde
	...
	k8s.io/api v0.25.0 // DO NOT BUMP
	k8s.io/apimachinery v0.25.0 // DO NOT BUMP
)
