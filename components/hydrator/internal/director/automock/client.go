...
func (_m *Client) GetSystemAuthByID(ctx context.Context, authID string) (*systemauth.SystemAuth, error) {
...
func (_m *Client) GetSystemAuthByToken(ctx context.Context, token string) (*systemauth.SystemAuth, error) {
...
func (_m *Client) UpdateSystemAuth(ctx context.Context, sysAuth *systemauth.SystemAuth) (director.UpdateAuthResult, error) {
