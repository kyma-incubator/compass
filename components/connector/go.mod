...
require (
	...
	github.com/kyma-incubator/compass/components/director v0.0.0-20211118123436-2be1b1dbf97b
...
replace (
	 github.com/kyma-incubator/compass/components/director =>  ../director
)