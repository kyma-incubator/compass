...
func (k formatterEntry) MarshalJSON() ([]byte, error) {
	type Entry formatterEntry
...
// Formatter is a logrus formatter that formats an entry for Kibana
