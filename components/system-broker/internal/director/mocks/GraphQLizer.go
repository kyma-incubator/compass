...
// PackageInstanceAuthRequestInputToGQL provides a mock function with given fields: in
func (_m *GraphQLizer) PackageInstanceAuthRequestInputToGQL(in graphql.PackageInstanceAuthRequestInput) (string, error) {
	ret := _m.Called(in)
