...
// ForPackageInstanceAuth provides a mock function with given fields:
func (_m *GqlFieldsProvider) ForPackageInstanceAuth() string {
	ret := _m.Called()
...
// ForPackageInstanceAuthStatus provides a mock function with given fields:
func (_m *GqlFieldsProvider) ForPackageInstanceAuthStatus() string {
	ret := _m.Called()
