...
ALTER TABLE webhooks
    ALTER COLUMN url_template TYPE text,
    ALTER COLUMN input_template TYPE text,
    ALTER COLUMN header_template TYPE text,
    ALTER COLUMN output_template TYPE text,
    ALTER COLUMN status_template TYPE text;
