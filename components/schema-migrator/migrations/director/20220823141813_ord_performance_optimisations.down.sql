...
DROP INDEX tenant_applications_tenant_id;
DROP INDEX tenant_runtimes_tenant_id;
DROP INDEX automatic_scenario_assignments_target_tenant_id;

-- drop views that rely on apps_subaccount view so that we can drop and change the view to func
