...
-- Add labels for webhook

ALTER TABLE labels
    ADD COLUMN webhook_id UUID;

ALTER TABLE labels
    ADD CONSTRAINT labels_webhook_id_fk FOREIGN KEY (webhook_id) REFERENCES webhooks(id) ON DELETE CASCADE;

-- Add SYSTEM_FIELD_DISCOVERY webhook_type
