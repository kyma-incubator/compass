...
CREATE TABLE cert_subject_mapping (
    ...
    consumer_type VARCHAR(256) NOT NULL CHECK ( consumer_type IN ('Runtime', 'Integration System', 'Application', 'Super Admin"', 'Business Integration', 'Technical Client', 'global')),
