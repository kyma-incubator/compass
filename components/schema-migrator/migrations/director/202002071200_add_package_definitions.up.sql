...
CREATE INDEX ON package_definitions (tenant_id);
CREATE UNIQUE INDEX ON package_definitions (tenant_id, package_id, id);
CREATE UNIQUE INDEX ON package_definitions (tenant_id, id);
...
ALTER TABLE api_definitions
    ADD CONSTRAINT api_definitions_package_definition_id_fk
        FOREIGN KEY (package_definitions_id) REFERENCES package_definitions (id) ON DELETE RESTRICT;
...
ALTER TABLE documents ADD COLUMN integration_system_id uuid;
