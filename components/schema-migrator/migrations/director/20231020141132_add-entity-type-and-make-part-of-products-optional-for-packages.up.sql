...
(
    ...
    app_id                      UUID,
        CONSTRAINT entitytype_app_id_ord_id_unique UNIQUE (app_id, ord_id),
        CONSTRAINT entitytype_app_id_fk FOREIGN KEY (app_id) REFERENCES applications (id) ON DELETE CASCADE,
    app_template_version_id     UUID,
        ...
        CONSTRAINT entitytype_app_template_version_id_fk FOREIGN KEY (app_template_version_id) REFERENCES app_template_versions (id) ON DELETE CASCADE,
    ...
    package_id                  UUID,
        CONSTRAINT entitytype_package_id_fk FOREIGN KEY (package_id) REFERENCES packages (id) ON DELETE CASCADE,
