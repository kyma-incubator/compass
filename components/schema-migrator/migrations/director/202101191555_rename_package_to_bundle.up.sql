...
ALTER TABLE api_definitions RENAME package_id TO bundle_id;
...
ALTER TABLE documents RENAME package_id TO bundle_id;
ALTER TABLE documents DROP CONSTRAINT documents_package_id_fk;
ALTER TABLE documents
    ADD CONSTRAINT documents_bundle_id_fk
        FOREIGN KEY (tenant_id, bundle_id) REFERENCES bundles(tenant_id, id) ON DELETE CASCADE;

ALTER TABLE event_api_definitions RENAME package_id TO bundle_id;
...
ALTER TABLE package_instance_auths RENAME package_id TO bundle_id;

ALTER TABLE package_instance_auths RENAME TO bundle_instance_auths;
