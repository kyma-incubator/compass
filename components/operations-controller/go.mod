...
require (
	...
	github.com/kyma-incubator/compass/components/director v0.0.0-20230222115142-245512ff99b8
	github.com/kyma-incubator/compass/components/system-broker v0.0.0-20230222121223-9f50416e25a1
