...
For local development and CI integration jobs, fixed Kyma version is used. To change Kyma version, see the [`README.md`](./installation/resources/README.md) in the `installation/resources` directory.
