...
sudo sh -c 'echo "\n$(minikube ip) connectivity-gateway.kyma.local connectivity-gateway-mtls.kyma.local compass-gateway-mtls.kyma.local compass-gateway-auth-oauth.kyma.local compass-gateway.kyma.local compass.kyma.local compass-mf.kyma.local" >> /etc/hosts'
