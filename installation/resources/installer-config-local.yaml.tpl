...
data:
  ...
  global.tenantFetchers.account-fetcher.oauth.tokenURL: "https://compass-external-services-mock.compass-system.svc.cluster.local:8081/cert/token"
  ...
  global.tenantFetchers.subaccount-fetcher.oauth.tokenURL: "https://compass-external-services-mock.compass-system.svc.cluster.local:8081/cert/token"
