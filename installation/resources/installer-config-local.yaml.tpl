...
data:
  ...
  global.tenantFetchers.external-mock.enabled: "true"
  global.tenantFetchers.external-mock.dbPool.maxOpenConnections: "1"
  global.tenantFetchers.external-mock.dbPool.maxIdleConnections: "1"
  global.tenantFetchers.external-mock.manageSecrets: "true"
  global.tenantFetchers.external-mock.secret.name: "compass-tenant-fetcher-secret-ext-svc-mock"
  global.tenantFetchers.external-mock.secret.clientIdKey: "client-id"
  global.tenantFetchers.external-mock.secret.clientSecretKey: "client-secret"
  global.tenantFetchers.external-mock.secret.oauthUrlKey: "url"
  global.tenantFetchers.external-mock.oauth.client: "client_id"
  global.tenantFetchers.external-mock.oauth.secret: "client_secret"
  global.tenantFetchers.external-mock.oauth.tokenURL: "http://compass-external-services-mock.compass-system.svc.cluster.local:8080/secured/oauth/token"
  global.tenantFetchers.external-mock.providerName: "external-svc-mock"
  global.tenantFetchers.external-mock.schedule: "0 23 * * *"
  global.tenantFetchers.external-mock.kubernetes.configMapNamespace: "compass-system"
  global.tenantFetchers.external-mock.kubernetes.pollInterval: "2s"
  global.tenantFetchers.external-mock.kubernetes.pollTimeout: "1m"
  global.tenantFetchers.external-mock.kubernetes.timeout: "2m"
  global.tenantFetchers.external-mock.fieldMapping.idField: "guid"
  global.tenantFetchers.external-mock.fieldMapping.nameField: "displayName"
  global.tenantFetchers.external-mock.fieldMapping.customerIdField: "customerId"
  global.tenantFetchers.external-mock.fieldMapping.discriminatorField: ""
  global.tenantFetchers.external-mock.fieldMapping.discriminatorValue: ""
  global.tenantFetchers.external-mock.fieldMapping.totalPagesField: "totalPages"
  global.tenantFetchers.external-mock.fieldMapping.totalResultsField: "totalResults"
  global.tenantFetchers.external-mock.fieldMapping.tenantEventsField: "events"
  global.tenantFetchers.external-mock.fieldMapping.detailsField: "eventData"
  global.tenantFetchers.external-mock.fieldMapping.entityTypeField: "type"
  global.tenantFetchers.external-mock.queryMapping.pageNumField: "page"
  global.tenantFetchers.external-mock.queryMapping.pageSizeField: "resultsPerPage"
  global.tenantFetchers.external-mock.queryMapping.timestampField: "ts"
  global.tenantFetchers.external-mock.query.startPage: "1"
  global.tenantFetchers.external-mock.query.pageSize: "1000"
  global.tenantFetchers.external-mock.shouldSyncSubaccounts: "false"
  global.tenantFetchers.external-mock.accountRegion: "local"
  global.tenantFetchers.external-mock.endpoints.accountCreated: "http://compass-external-services-mock.compass-system.svc.cluster.local:8080/tenant-fetcher/global-account-create"
  global.tenantFetchers.external-mock.endpoints.accountDeleted: "http://compass-external-services-mock.compass-system.svc.cluster.local:8080/tenant-fetcher/global-account-delete"
  global.tenantFetchers.external-mock.endpoints.accountUpdated: "http://compass-external-services-mock.compass-system.svc.cluster.local:8080/tenant-fetcher/global-account-update"
